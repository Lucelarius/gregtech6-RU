...
public class FoodStat implements IFoodStat {
	...
	public void addAdditionalToolTips(Item aItem, List<String> aList, ItemStack aStack, boolean aF3_H) {
		if ((!useAppleCoreFunctionality(aItem, aStack, null)) && (mFoodLevel > 0 || mSaturation > 0.0F)) aList.add(LH.Chat.RED + "Еда: " + mFoodLevel + " - Насыщение: " + mSaturation);
		...
		if (mExplosive) aList.add(LH.Chat.DRED + "пахнет взрывчаткой");
