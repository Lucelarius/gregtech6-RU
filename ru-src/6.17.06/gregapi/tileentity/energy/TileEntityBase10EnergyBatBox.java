...
public abstract class TileEntityBase10EnergyBatBox extends TileEntityBase09FacingSingle implements ITileEntityEnergy, ITileEntityEnergyDataCapacitor, ITileEntityRunningActively, ITileEntitySwitchableOnOff, ITileEntitySwitchableMode, ITileEntityProgress {
	...
	static {LH.add("gt.tooltip.energybattery.1", "Настройщик может устанавливать количество испускаемых пакетов");}
	static {LH.add("gt.tooltip.energybattery.2", "Режим 0 = Испускает максимальное количество (значение по умолчанию)");}
	static {LH.add("gt.tooltip.energybattery.3", "Режим 1-15 = Испускает до 1-15 пакетов, если накопителей энергии достаточно");}
