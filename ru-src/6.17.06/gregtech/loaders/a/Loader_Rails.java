...
public class Loader_Rails implements Runnable {
	@Override
	public void run() {
		BlocksGT.RailRoad                    = new BlockRailRoad(null, "gt.block.rail.road"                    , "Дорожная полоса"                              , 0.50F, 20,                                 0, Textures.BlockIcons.RAIL_ROAD_STRIPE             , Textures.BlockIcons.RAIL_ROAD_REFLECTOR);
		
		BlocksGT.RailAluminium               = new BlockBaseRail(null, "gt.block.rail.aluminium"               , "Рельсы (Алюминий)"                      , F, F, 0.20F,  6, MT.Al             .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_ALUMINIUM      , Textures.BlockIcons.RAIL_TURNED_ALUMINIUM);
		BlocksGT.RailBronze                  = new BlockBaseRail(null, "gt.block.rail.bronze"                  , "Рельсы (Бронза)"                        , F, F, 0.30F,  8, MT.Bronze         .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_BRONZE         , Textures.BlockIcons.RAIL_TURNED_BRONZE);
		BlocksGT.RailMagnalium               = new BlockBaseRail(null, "gt.block.rail.magnalium"               , "Рельсы (Магналий)"                      , F, F, 0.60F, 12, MT.Magnalium      .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_MAGNALIUM      , Textures.BlockIcons.RAIL_TURNED_MAGNALIUM);
		BlocksGT.RailSteel                   = new BlockBaseRail(null, "gt.block.rail.steel"                   , "Рельсы (Сталь)"                         , F, F, 0.60F, 12, MT.Steel          .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_STEEL          , Textures.BlockIcons.RAIL_TURNED_STEEL);
		BlocksGT.RailStainlessSteel          = new BlockBaseRail(null, "gt.block.rail.stainlesssteel"          , "Рельсы (Нержавеющая сталь)"             , F, F, 0.80F, 10, MT.StainlessSteel .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_STAINLESSSTEEL , Textures.BlockIcons.RAIL_TURNED_STAINLESSSTEEL);
		BlocksGT.RailTungsten                = new BlockBaseRail(null, "gt.block.rail.tungsten"                , "Рельсы (Вольфрам)"                      , F, F, 1.00F, 20, MT.W              .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_TUNGSTEN       , Textures.BlockIcons.RAIL_TURNED_TUNGSTEN);
		BlocksGT.RailTitanium                = new BlockBaseRail(null, "gt.block.rail.titanium"                , "Рельсы (Титан)"                         , F, F, 1.20F, 16, MT.Ti             .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_TITANIUM       , Textures.BlockIcons.RAIL_TURNED_TITANIUM);
		BlocksGT.RailTungstenSteel           = new BlockBaseRail(null, "gt.block.rail.tungstensteel"           , "Рельсы (Вольфрамовая сталь)"            , F, F, 1.40F, 20, MT.TungstenSteel  .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_TUNGSTENSTEEL  , Textures.BlockIcons.RAIL_TURNED_TUNGSTENSTEEL);
		BlocksGT.RailTungstenCarbide         = new BlockBaseRail(null, "gt.block.rail.tungstencarbide"         , "Рельсы (Карбид вольфрама)"              , F, F, 1.60F, 24, MT.TungstenCarbide.mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_TUNGSTENCARBIDE, Textures.BlockIcons.RAIL_TURNED_TUNGSTENCARBIDE);
		BlocksGT.RailAdamantium              = new BlockBaseRail(null, "gt.block.rail.adamantium"              , "Рельсы (Адамантий)"                     , F, F, 4.00F,100, MT.Ad             .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_ADAMANTIUM     , Textures.BlockIcons.RAIL_TURNED_ADAMANTIUM);
		
		BlocksGT.RailAluminiumBooster        = new BlockBaseRail(null, "gt.block.rail.booster.aluminium"       , "Ускоряющие рельсы (Алюминий)"           , T, F, 0.20F,  6, MT.Al             .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_ALUMINIUM       , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_ALUMINIUM);
		BlocksGT.RailBronzeBooster           = new BlockBaseRail(null, "gt.block.rail.booster.bronze"          , "Ускоряющие рельсы (Бронза)"             , T, F, 0.30F,  8, MT.Bronze         .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_BRONZE          , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_BRONZE);
		BlocksGT.RailMagnaliumBooster        = new BlockBaseRail(null, "gt.block.rail.booster.magnalium"       , "Ускоряющие рельсы (Магналий)"           , T, F, 0.60F, 12, MT.Magnalium      .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_MAGNALIUM       , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_MAGNALIUM);
		BlocksGT.RailSteelBooster            = new BlockBaseRail(null, "gt.block.rail.booster.steel"           , "Ускоряющие рельсы (Сталь)"              , T, F, 0.60F, 12, MT.Steel          .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_STEEL           , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_STEEL);
		BlocksGT.RailStainlessSteelBooster   = new BlockBaseRail(null, "gt.block.rail.booster.stainlesssteel"  , "Ускоряющие рельсы (Нержавеющая сталь)"  , T, F, 0.80F, 10, MT.StainlessSteel .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_STAINLESSSTEEL  , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_STAINLESSSTEEL);
		BlocksGT.RailTungstenBooster         = new BlockBaseRail(null, "gt.block.rail.booster.tungsten"        , "Ускоряющие рельсы (Вольфрам)"           , T, F, 1.00F, 20, MT.W              .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_TUNGSTEN        , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_TUNGSTEN);
		BlocksGT.RailTitaniumBooster         = new BlockBaseRail(null, "gt.block.rail.booster.titanium"        , "Ускоряющие рельсы (Титан)"              , T, F, 1.20F, 16, MT.Ti             .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_TITANIUM        , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_TITANIUM);
		BlocksGT.RailTungstenSteelBooster    = new BlockBaseRail(null, "gt.block.rail.booster.tungstensteel"   , "Ускоряющие рельсы (Вольфрамовая сталь)" , T, F, 1.40F, 20, MT.TungstenSteel  .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_TUNGSTENSTEEL   , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_TUNGSTENSTEEL);
		BlocksGT.RailTungstenCarbideBooster  = new BlockBaseRail(null, "gt.block.rail.booster.tungstencarbide" , "Ускоряющие рельсы (Карбид вольфрама)"   , T, F, 1.60F, 24, MT.TungstenCarbide.mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_TUNGSTENCARBIDE , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_TUNGSTENCARBIDE);
		BlocksGT.RailAdamantiumBooster       = new BlockBaseRail(null, "gt.block.rail.booster.adamantium"      , "Ускоряющие рельсы (Адамантий)"          , T, F, 4.00F,100, MT.Ad             .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_ADAMANTIUM      , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_ADAMANTIUM);
		
		BlocksGT.RailAluminiumDetector       = new BlockBaseRail(null, "gt.block.rail.detector.aluminium"      , "Рельсы с датчиком (Алюминий)"           , F, T, 0.20F,  6, MT.Al             .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_ALUMINIUM      , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_ALUMINIUM);
		BlocksGT.RailBronzeDetector          = new BlockBaseRail(null, "gt.block.rail.detector.bronze"         , "Рельсы с датчиком (Бронза)"             , F, T, 0.30F,  8, MT.Bronze         .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_BRONZE         , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_BRONZE);
		BlocksGT.RailMagnaliumDetector       = new BlockBaseRail(null, "gt.block.rail.detector.magnalium"      , "Рельсы с датчиком (Магналий)"           , F, T, 0.60F, 12, MT.Magnalium      .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_MAGNALIUM      , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_MAGNALIUM);
		BlocksGT.RailSteelDetector           = new BlockBaseRail(null, "gt.block.rail.detector.steel"          , "Рельсы с датчиком (Сталь)"              , F, T, 0.60F, 12, MT.Steel          .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_STEEL          , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_STEEL);
		BlocksGT.RailStainlessSteelDetector  = new BlockBaseRail(null, "gt.block.rail.detector.stainlesssteel" , "Рельсы с датчиком (Нержавеющая сталь)"  , F, T, 0.80F, 10, MT.StainlessSteel .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_STAINLESSSTEEL , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_STAINLESSSTEEL);
		BlocksGT.RailTungstenDetector        = new BlockBaseRail(null, "gt.block.rail.detector.tungsten"       , "Рельсы с датчиком (Вольфрам)"           , F, T, 1.00F, 20, MT.W              .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_TUNGSTEN       , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_TUNGSTEN);
		BlocksGT.RailTitaniumDetector        = new BlockBaseRail(null, "gt.block.rail.detector.titanium"       , "Рельсы с датчиком (Титан)"              , F, T, 1.20F, 16, MT.Ti             .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_TITANIUM       , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_TITANIUM);
		BlocksGT.RailTungstenSteelDetector   = new BlockBaseRail(null, "gt.block.rail.detector.tungstensteel"  , "Рельсы с датчиком (Вольфрамовая сталь)" , F, T, 1.40F, 20, MT.TungstenSteel  .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_TUNGSTENSTEEL  , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_TUNGSTENSTEEL);
		BlocksGT.RailTungstenCarbideDetector = new BlockBaseRail(null, "gt.block.rail.detector.tungstencarbide", "Рельсы с датчиком (Карбид вольфрама)"   , F, T, 1.60F, 24, MT.TungstenCarbide.mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_TUNGSTENCARBIDE, Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_TUNGSTENCARBIDE);
		BlocksGT.RailAdamantiumDetector      = new BlockBaseRail(null, "gt.block.rail.detector.adamantium"     , "Рельсы с датчиком (Адамантий)"          , F, T, 4.00F,100, MT.Ad             .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_ADAMANTIUM     , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_ADAMANTIUM);
