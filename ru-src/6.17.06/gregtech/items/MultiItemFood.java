...
public class MultiItemFood extends MultiItemRandomWithCompat implements IItemRottable {
	...
	public void addItems() {
		...
		IL.Tusk         .set(addItem(12400, "Бивень"           , ""                 , OD.itemTusk              , TC.stack(TC.BESTIA, 2), TC.stack(TC.FAMES, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		IL.Tusk_Hoglin  .set(addItem(12401, "Хоглинский бивень", "нет золота"       , OD.itemTusk              , TC.stack(TC.BESTIA, 2), TC.stack(TC.FAMES, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		IL.Tusk_Boar    .set(addItem(12402, "Клык кабана"      , ""                 , OD.itemTusk              , TC.stack(TC.BESTIA, 2), TC.stack(TC.FAMES, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		IL.Tusk_Elephant.set(addItem(12403, "Слоновий бивень"  , "Слоновая кость"   , OD.itemTusk, OD.itemIvory, TC.stack(TC.BESTIA, 3), TC.stack(TC.FAMES, 3), TC.stack(TC.LUCRUM, 3))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		
		IL.Hoof         .set(addItem(12500, "Копыто"           , ""                 , OD.itemHoof              , TC.stack(TC.BESTIA, 2), TC.stack(TC.ITER, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		IL.Hoof_Cow     .set(addItem(12501, "Коровье копыто"   , ""                 , OD.itemHoof              , TC.stack(TC.BESTIA, 2), TC.stack(TC.ITER, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		IL.Hoof_Horse   .set(addItem(12502, "Лошадиное копыто" , "не достоин гонок" , OD.itemHoof              , TC.stack(TC.BESTIA, 2), TC.stack(TC.ITER, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		IL.Hoof_Mule    .set(addItem(12503, "Копыто мула"      , ""                 , OD.itemHoof              , TC.stack(TC.BESTIA, 2), TC.stack(TC.ITER, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		IL.Hoof_Donkey  .set(addItem(12504, "Ослиное копыто"   , ""                 , OD.itemHoof              , TC.stack(TC.BESTIA, 2), TC.stack(TC.ITER, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		IL.Hoof_Deer    .set(addItem(12505, "Оленье копыто"    , ""                 , OD.itemHoof              , TC.stack(TC.BESTIA, 2), TC.stack(TC.ITER, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		
		IL.Horn         .set(addItem(12600, "Рог"              , ""                 , OD.itemHorn              , TC.stack(TC.BESTIA, 2), TC.stack(TC.TELUM, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		IL.Horn_Cow     .set(addItem(12601, "Коровий рог"      , ""                 , OD.itemHorn              , TC.stack(TC.BESTIA, 2), TC.stack(TC.TELUM, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		IL.Horn_Sheep   .set(addItem(12602, "Бараний рог"      , "От рогатой овцы"  , OD.itemHorn              , TC.stack(TC.BESTIA, 2), TC.stack(TC.TELUM, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		
		IL.Antler       .set(addItem(12700, "Оленьи рога"      , ""                 , OD.itemAntler            , TC.stack(TC.BESTIA, 2), TC.stack(TC.INSTRUMENTUM, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
		IL.Antler_Deer  .set(addItem(12701, "Красный оленьи рога", "о родной..."    , OD.itemAntler            , TC.stack(TC.BESTIA, 2), TC.stack(TC.INSTRUMENTUM, 2))); if (COMPAT_FR != null) COMPAT_FR.addToBackpacks("hunter", last());
