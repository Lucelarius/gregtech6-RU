...
public class MultiItemTechnological extends MultiItemRandomWithCompat {
	...
	public void addItems() {
		...
		IL.Battery_Lead_Acid_Cell_Filled   .set(addItem(20001, "Свинцово-кислотная капсула (Заполнено)", "Часть аккумулятора"                             , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.ELECTRUM, 2), TC.stack(TC.VENEMUM, 2), new OreDictItemData(MT.Pb, U, MT.BatteryAlloy, U, MT.H2SO4, 2*U), new FluidContainerData(MT.H2SO4.liquid(2*U, T), next(), last(), F)));
