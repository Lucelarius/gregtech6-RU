...
public class MultiItemBottles extends MultiItemRandomWithCompat implements IItemRottable {
	...
	public void addItems() {
		...
		addItem(  804, "Это не коровий соус"          , "", "foodHotsauce"                    , FL.Sauce_Cow_Level        .make(250), TC.stack(TC.VITREUS, 1), TC.stack(TC.VENEMUM        , 3), TC.stack(TC.IGNIS     , 5), FoodStatFluid.INSTANCE, TD.Creative.HIDDEN); Sandwiches.INGREDIENTS.put(last(), DYE_INDEX_Red);
		...
		addItem( 1000, "Оливковое масло"   , "Растительное масло", OP.bottle.dat(MT.OliveOil)    , FL.Oil_Olive           .make(250), TC.stack(TC.VITREUS, 1), TC.stack(TC.AQUA           , 1), TC.stack(TC.LUX       , 1), FoodStatFluid.INSTANCE, OD.container250seedoil); Sandwiches.INGREDIENTS.put(last(), DYE_INDEX_Lime);
		addItem( 1001, "Подсолнечное масло", "Растительное масло", OP.bottle.dat(MT.SunflowerOil), FL.Oil_Sunflower       .make(250), TC.stack(TC.VITREUS, 1), TC.stack(TC.AQUA           , 1), TC.stack(TC.LUX       , 1), FoodStatFluid.INSTANCE, OD.container250seedoil); Sandwiches.INGREDIENTS.put(last(), DYE_INDEX_Yellow);
		addItem( 1002, "Ореховое масло"    , "Растительное масло", OP.bottle.dat(MT.NutOil)      , FL.Oil_Nut             .make(250), TC.stack(TC.VITREUS, 1), TC.stack(TC.AQUA           , 1), TC.stack(TC.LUX       , 1), FoodStatFluid.INSTANCE, OD.container250seedoil); Sandwiches.INGREDIENTS.put(last(), DYE_INDEX_Yellow);
		addItem( 1003, "Растительное масло", "Растительное масло", OP.bottle.dat(MT.SeedOil)     , FL.Oil_Seed            .make(250), TC.stack(TC.VITREUS, 1), TC.stack(TC.AQUA           , 1), TC.stack(TC.LUX       , 1), FoodStatFluid.INSTANCE, OD.container250seedoil); Sandwiches.INGREDIENTS.put(last(), DYE_INDEX_Lime);
		addItem( 1004, "Конопляное масло"  , "Растительное масло", OP.bottle.dat(MT.HempOil)     , FL.Oil_Hemp            .make(250), TC.stack(TC.VITREUS, 1), TC.stack(TC.AQUA           , 1), TC.stack(TC.LUX       , 1), FoodStatFluid.INSTANCE, OD.container250seedoil); Sandwiches.INGREDIENTS.put(last(), DYE_INDEX_Lime);
		addItem( 1005, "Льняное масло"     , "Растительное масло", OP.bottle.dat(MT.LinOil)      , FL.Oil_Lin             .make(250), TC.stack(TC.VITREUS, 1), TC.stack(TC.AQUA           , 1), TC.stack(TC.LUX       , 1), FoodStatFluid.INSTANCE, OD.container250seedoil); Sandwiches.INGREDIENTS.put(last(), DYE_INDEX_Lime);
		addItem( 1006, "Рыбий жир"         , "Растительное масло", OP.bottle.dat(MT.FishOil)     , FL.Oil_Fish            .make(250), TC.stack(TC.VITREUS, 1), TC.stack(TC.AQUA           , 1), TC.stack(TC.LUX       , 1), FoodStatFluid.INSTANCE); Sandwiches.INGREDIENTS.put(last(), DYE_INDEX_Yellow);
		addItem( 1007, "Китовый жир"       , "Растительное масло", OP.bottle.dat(MT.WhaleOil)    , FL.Oil_Whale           .make(250), TC.stack(TC.VITREUS, 1), TC.stack(TC.AQUA           , 1), TC.stack(TC.LUX       , 1), FoodStatFluid.INSTANCE); Sandwiches.INGREDIENTS.put(last(), DYE_INDEX_Brown);
		...
		addItem( 5600, "Кокосовое молоко", "Растительное масло", "foodCoconutmilk"            , FL.Juice_Coconut          .make(250), TC.stack(TC.VITREUS, 1), TC.stack(TC.AQUA           , 1), TC.stack(TC.SANO      , 1), FoodStatFluid.INSTANCE, OD.container250juice);
		...
		addItem(32760, "Бутылка яда", "", "bottlePoison", OD.container250poison, FL.Poison.make(250), TC.stack(TC.VITREUS, 1), TC.stack(TC.VENEMUM, 2), FoodStatFluid.INSTANCE)); Sandwiches.INGREDIENTS.put(last(), DYE_INDEX_Purple);
		...
		IL.Bottle_Loot.set(
		addItem(32761, "Помутневшая бутылка", "Добыча: Случайная бутылка", TC.stack(TC.VITREUS, 1), TC.stack(TC.LUCRUM, 1), new Behavior_Drop_Loot("gt.bottles")));

		IL.Bottle_Tar.set(
		addItem(32762, "Деготь в бутылке", "Можно использовать и как клей", "bottleTar", DYE_OREDICTS[DYE_INDEX_Black ], FL.Tar.make(250), FL.make("tarfluid", 250), TC.stack(TC.VITREUS, 1), TC.stack(TC.LIMUS, 1), TC.stack(TC.IGNIS, 1), FoodStatFluid.INSTANCE));
