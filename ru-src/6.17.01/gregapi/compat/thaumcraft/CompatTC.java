...
public class CompatTC extends CompatBase implements ICompatTC {
	public CompatTC() {
		LH.add("tc.aspect.strontio" , "Глупость, Некомпетентность");
		LH.add("tc.aspect.nebrisum" , "Обман, Рейдерство, Обогащение");
		LH.add("tc.aspect.electrum" , "Электричество, Молния");
		LH.add("tc.aspect.magneto"  , "Магнетизм, Притяжение");
		LH.add("tc.aspect.radio"    , "Радиация");
