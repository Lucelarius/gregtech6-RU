...
public class MultiTileEntityCryoDistillationTower extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.cryodistillationtower.1", "3x3 Основа из теплопередатчиков. Они также передают холод. ;)");
		LH.add("gt.tooltip.multiblock.cryodistillationtower.2", "3x3x8 из частей ректификационной колонны");
		LH.add("gt.tooltip.multiblock.cryodistillationtower.3", "Главный блок распологается по центру сбоку снизу и направлен наружу");
		LH.add("gt.tooltip.multiblock.cryodistillationtower.4", "Вывод автоматический на задней стороне");
		LH.add("gt.tooltip.multiblock.cryodistillationtower.5", "Нижнее отверстие предназначено для вывода предметов");
		LH.add("gt.tooltip.multiblock.cryodistillationtower.6", "Подача возможна только в нижнем слое башни");
	}
