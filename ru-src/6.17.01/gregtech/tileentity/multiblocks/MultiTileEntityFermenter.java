...
public class MultiTileEntityFermenter extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.fermenter.1", "5x5 из теплопередатчиков как нижний слой");
		LH.add("gt.tooltip.multiblock.fermenter.2", "5x5x2 из стен из нержавеющей стали");
		LH.add("gt.tooltip.multiblock.fermenter.3", "Главный блок распологается по центру сбоку по середине и направлен наружу");
		LH.add("gt.tooltip.multiblock.fermenter.4", "Стены используются для ввода, вывод предметов - верх, вывод жидкостей - низ");
	}
