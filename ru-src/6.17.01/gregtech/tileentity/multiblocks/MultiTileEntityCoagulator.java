...
public class MultiTileEntityCoagulator extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.coagulator.1", "5x5x2 из стен из нержавеющей стали");
		LH.add("gt.tooltip.multiblock.coagulator.2", "Главный блок распологается по центру сбоку снизу и направлен наружу");
		LH.add("gt.tooltip.multiblock.coagulator.3", "Ввод и вывод с любых блоков");
	}
