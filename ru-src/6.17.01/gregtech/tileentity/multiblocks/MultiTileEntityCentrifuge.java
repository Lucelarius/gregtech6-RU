...
public class MultiTileEntityCentrifuge extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.centrifuge.1", "3x3x2 из частей центрифуги");
		LH.add("gt.tooltip.multiblock.centrifuge.2", "Главный блок распологается по центру сбоку снизу и направлен наружу");
		LH.add("gt.tooltip.multiblock.centrifuge.3", "Ввод и вывод с любых блоков");
	}
