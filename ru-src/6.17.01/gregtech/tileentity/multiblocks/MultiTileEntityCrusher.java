...
public class MultiTileEntityCrusher extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.crusher.1", "5x5x3 бассейн из 56 стен из вольфрамовой стали");
		LH.add("gt.tooltip.multiblock.crusher.2", "3x3x2 Заполнение колесами дробилки");
		LH.add("gt.tooltip.multiblock.crusher.3", "Главный блок распологается по центру сбоку снизу и направлен наружу");
		LH.add("gt.tooltip.multiblock.crusher.4", "Ввод только на колеса дробилки, вывод в нижнем слое");
	}
