...
public class MultiTileEntityBath extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.bath.1", "5x5x2 из стен из нержавеющей стали");
		LH.add("gt.tooltip.multiblock.bath.2", "Главный блок распологается по центру сбоку снизу и направлен наружу");
		LH.add("gt.tooltip.multiblock.bath.3", "Ввод и вывод с любых блоков");
	}
