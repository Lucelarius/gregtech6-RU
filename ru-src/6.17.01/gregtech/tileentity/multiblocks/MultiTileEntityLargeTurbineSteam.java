...
public class MultiTileEntityLargeTurbineSteam extends MultiTileEntityLargeTurbine {
	...
	static {
		LH.add("gt.tooltip.multiblock.steamturbine.1", "3x3x4 из 35 ");
		LH.add("gt.tooltip.multiblock.steamturbine.2", "Главный блок по центру стороны 3х3 и направлен наружу");
		LH.add("gt.tooltip.multiblock.steamturbine.3", "Ввод возможен только на фронтальной стороне 3x3");
		LH.add("gt.tooltip.multiblock.steamturbine.4", "Дистиллированная вода может быть откачана в нижнем слое");
	}
