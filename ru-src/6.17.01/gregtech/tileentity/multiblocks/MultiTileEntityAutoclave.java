...
public class MultiTileEntityAutoclave extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.autoclave.1", "Полая 3x3x3 из прочных стен из нержавеющей стали");
		LH.add("gt.tooltip.multiblock.autoclave.2", "Главный блок распологается по центру сбоку снизу и направлен наружу");
		LH.add("gt.tooltip.multiblock.autoclave.3", "Ввод и вывод из любого блока");
	}
