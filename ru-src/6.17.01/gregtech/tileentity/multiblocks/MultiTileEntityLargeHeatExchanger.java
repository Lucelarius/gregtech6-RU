...
public class MultiTileEntityLargeHeatExchanger extends TileEntityBase10MultiBlockBase implements IFluidHandler, ITileEntityRunningActively, ITileEntityEnergy, IMultiBlockFluidHandler, IMultiBlockEnergy {
	...
	static {
		LH.add("gt.tooltip.multiblock.heatexchanger.1", "3x3 кольцо из 8 прочных вольфрамовых стен и главным блоком в центре");
		LH.add("gt.tooltip.multiblock.heatexchanger.2", "3x3 кольцо из 8 теплопередатчиков и прочной вольфрамовой стены в центре");
		LH.add("gt.tooltip.multiblock.heatexchanger.3", "Выход энергии через 8 теплопередатчиков (Верх)");
		LH.add("gt.tooltip.multiblock.heatexchanger.4", "Ввод в нижнем слое, вывод жидкости через главный блок");
	}
	...
	public void onMagnifyingGlass2(List<String> aChatReturn) {
		aChatReturn.add("Структура уже сформирована!");
		aChatReturn.add("Вход: "  + mTanks[0].content());
		aChatReturn.add("Выход: " + mTanks[1].content());
	}
