...
public class MultiTileEntityLargeTurbineGas extends MultiTileEntityLargeTurbine {
	...
	static {
		LH.add("gt.tooltip.multiblock.gasturbine.1", "3x3x4 из 35 ");
		LH.add("gt.tooltip.multiblock.gasturbine.2", "Главный блок распологается в центре стороны 3х3 и направлен наружу");
		LH.add("gt.tooltip.multiblock.gasturbine.3", "Ввод возможен только на фронтальной стороне 3x3");
		LH.add("gt.tooltip.multiblock.gasturbine.4", "Выхлопные газы должны удаляться!");
	}
