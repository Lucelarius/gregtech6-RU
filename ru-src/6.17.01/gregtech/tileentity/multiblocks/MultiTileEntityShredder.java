...
public class MultiTileEntityShredder extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.shredder.1", "5x5x3 бассейн из 56 стен из вольфрамовой стали");
		LH.add("gt.tooltip.multiblock.shredder.2", "3x3x2 заполнение лезвиями измельчителя");
		LH.add("gt.tooltip.multiblock.shredder.3", "Главный блок распологается по центру сбоку снизу и направлен наружу");
		LH.add("gt.tooltip.multiblock.shredder.4", "Ввод только на лезвия измельчителя, вывод на нижний слой");
	}
