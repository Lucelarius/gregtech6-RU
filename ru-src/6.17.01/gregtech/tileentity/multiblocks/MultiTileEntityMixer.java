...
public class MultiTileEntityMixer extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.mixer.1", "3x3x2 из стен из нержавеющей стали");
		LH.add("gt.tooltip.multiblock.mixer.2", "Главный блок распологается по центру сбоку снизу и направлен наружу");
		LH.add("gt.tooltip.multiblock.mixer.3", "Верхняя часть - ввод, нижняя и главный блок - вывод");
	}
