...
public class MultiTileEntitySluice extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.sluice.1", "2 слоя 3х7 из титановых стен");
		LH.add("gt.tooltip.multiblock.sluice.2", "Слой 3x7 сверху из частей ломтерезки");
		LH.add("gt.tooltip.multiblock.sluice.3", "Главный блок распологается по центру на малой стороне и направлен наружу");
		LH.add("gt.tooltip.multiblock.sluice.4", "Ввод только в верхней части дальней стороны");
		LH.add("gt.tooltip.multiblock.sluice.5", "Вывод только в нижней части закрытой стороны");
	}
