...
public class MultiTileEntityLargeDynamo extends TileEntityBase11MultiBlockConverter implements ITileEntitySwitchableOnOff {
	...
	static {
		LH.add("gt.tooltip.multiblock.dynamo.1", "Два вертикальных кольца 3х3 из того же материала, что и главный блок,");
		LH.add("gt.tooltip.multiblock.dynamo.2", "и 18 большими медными катушками 3х3х3 между ними");
		LH.add("gt.tooltip.multiblock.dynamo.3", "Главный блок распологается в центре на одном из колец и направлен наружу");
	}
