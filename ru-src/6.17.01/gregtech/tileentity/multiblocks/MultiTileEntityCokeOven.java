...
public class MultiTileEntityCokeOven extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.cokeoven.1", "Полая 3x3x3 из 25 огнеупорных кирпичей наполненная воздухом");
		LH.add("gt.tooltip.multiblock.cokeoven.2", "Главный блок в центре сбоку и направлен наружу");
	}
