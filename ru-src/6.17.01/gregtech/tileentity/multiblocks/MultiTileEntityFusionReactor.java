...
public class MultiTileEntityFusionReactor extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.fusionreactor.1", "Для инструкций по строительству прочитайте Руководство или ГИ.");
		LH.add("gt.tooltip.multiblock.fusionreactor.2", "144 иридиевых катушек, 576 обычных стен из вольфрамовой стали, 50 Вентиляционных отверстий.");
		LH.add("gt.tooltip.multiblock.fusionreactor.3", "36 Обычных стен из нержавеющей стали, 53 стены из оцинкованной стали.");
		LH.add("gt.tooltip.multiblock.fusionreactor.4", "3 Универсальных, 12 Логических и 12 Управляющих модулей 4-х ядерного процессора.");
		LH.add("gt.tooltip.multiblock.fusionreactor.5", "Выход энергии на электрических интерфейсах");
		LH.add("gt.tooltip.multiblock.fusionreactor.6", "Лазерный вход на стеклянном кольце");
		LH.add("gt.tooltip.multiblock.fusionreactor.7", "Предметы и жидкости обрабатываются на обычных стенах");
	}
