...
public class BlockTreeLogC extends BlockBaseLogFlammable implements IBlockToolable {
	public BlockTreeLogC(String aUnlocalised) {
		...
		LH.add(getUnlocalizedName()+ ".0", "Бревно голубой ели");
		LH.add(getUnlocalizedName()+ ".4", "Бревно голубой ели");
		LH.add(getUnlocalizedName()+ ".8", "Бревно голубой ели");
		LH.add(getUnlocalizedName()+".12", "Бревно голубой ели");
