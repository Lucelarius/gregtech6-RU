...
public class MultiItemTechnological extends MultiItemRandomWithCompat {
	...
	public void addItems() {
		...
		IL.Cover_Detector_Possible               .set(addItem(tLastID =  1015, "Датчик активности (Ожидание)"                      , "Выдает сигнал красного камня при готовности"                             , new CoverDetectorRunningPossible()                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Detector_Passively              .set(addItem(tLastID =  1016, "Датчик активности (Активно)"                       , "Выдает сигнал красного камня когда запущен"                              , new CoverDetectorRunningPassively()                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Detector_Actively               .set(addItem(tLastID =  1017, "Датчик активности (Обработка)"                     , "Выдает сигнал красного камня при обработке"                              , new CoverDetectorRunningActively()                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Scale_Progress                  .set(addItem(tLastID =  1018, "Датчик прогресса"                                  , "Излучает сигнал красного камня в зависимости от прогресса"               , new CoverScaleProgress()                                   , TC.stack(TC.MACHINA, 2), TC.stack(TC.FABRICO, 1)));
		IL.Cover_Detector_Success                .set(addItem(tLastID =  1019, "Датчик активности (Успех)"                         , "Выдает сигнал красного камня при оканчании процесса"                     , new CoverDetectorRunningSuccessfully()                     , TC.stack(TC.MACHINA, 2), TC.stack(TC.FABRICO, 1)));
		...
		IL.Cover_Redstone_Conductor_IN           .set(addItem(tLastID =  1029, "Крышка проводника сигнала кр.камня (Прием)"        , "Сигнал красного камня перейдет к излучающим проводникам"                 , new CoverRedstoneConductorIN()                             , TC.stack(TC.MACHINA, 2), TC.stack(TC.SENSUS, 1)));
		IL.Cover_Redstone_Conductor_OUT          .set(addItem(tLastID =  1030, "Крышка проводника сигнала кр.камня (Излучение)"    , "Сигнал красного камня предеается на принимающий проводник"               , new CoverRedstoneConductorOUT()                            , TC.stack(TC.MACHINA, 2), TC.stack(TC.VINCULUM, 1)));
