...
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                           .setMaterialAmount(3*U                                       ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH             , "Разводной ключ"                          , "Удерживайте ЛКМ, чтобы демонтировать машины"                   , new GT_Tool_MonkeyWrench()                                     .setMaterialAmount(6*U                                       ), OreDictToolNames.monkeywrench                                                                                                            , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.MACHINA       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_monkeywrench);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH_LV                 , "Электроключ (LV)"                        , "Нажмите ПКМ, чтобы переключиться на разводной ключ"            , new GT_Tool_Wrench_LV(ToolsGT.MONKEY_WRENCH_LV)                .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.wrench                                                                                                                  , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_wrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH_MV                 , "Электроключ (MV)"                        , "Нажмите ПКМ, чтобы переключиться на разводной ключ"            , new GT_Tool_Wrench_MV(ToolsGT.MONKEY_WRENCH_MV)                .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.wrench                                                                                                                  , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_wrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH_HV                 , "Электроключ (HV)"                        , "Нажмите ПКМ, чтобы переключиться на разводной ключ"            , new GT_Tool_Wrench_HV(ToolsGT.MONKEY_WRENCH_HV)                .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.wrench                                                                                                                  , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_wrench);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH_LV          , "Разводной электроключ (LV)"              , "Нажмите ПКМ, чтобы переключиться на гаечный ключ"              , new GT_Tool_MonkeyWrench_LV(ToolsGT.WRENCH_LV)                 .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.monkeywrench                                                                                                            , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_monkeywrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH_MV          , "Разводной электроключ (MV)"              , "Нажмите ПКМ, чтобы переключиться на гаечный ключ"              , new GT_Tool_MonkeyWrench_MV(ToolsGT.WRENCH_MV)                 .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.monkeywrench                                                                                                            , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_monkeywrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH_HV          , "Разводной электроключ (HV)"              , "Нажмите ПКМ, чтобы переключиться на гаечный ключ"              , new GT_Tool_MonkeyWrench_HV(ToolsGT.WRENCH_HV)                 .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.monkeywrench                                                                                                            , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_monkeywrench);
