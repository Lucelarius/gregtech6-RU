...
public class Loader_Tools implements Runnable {
	...
	public void run() {
		...
		ArmorsGT.HAZMATS_INSECTS    .add(ArmorsGT.HAZMAT_INSECTS    [0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.head"     , "Защитная маска от насекомых"            , "Полный набор защищает от любых насекомых"       , "hazard_insects"   , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RRR", "RGR", "q l", 'R', foil.dat(ANY.Rubber), 'G', ST.make(Blocks.stained_glass_pane, 1, 15-DYE_INDEX_Black)));
		ArmorsGT.HAZMATS_INSECTS    .add(ArmorsGT.HAZMAT_INSECTS    [1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.chest"    , "Защитная рубашка от насекомых"          , "Полный набор защищает от любых насекомых"       , "hazard_insects"   , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RqR", "RRR", "RRR", 'R', foil.dat(ANY.Rubber)));
		ArmorsGT.HAZMATS_INSECTS    .add(ArmorsGT.HAZMAT_INSECTS    [2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.legs"     , "Защитные штаны от насекомых"            , "Полный набор защищает от любых насекомых"       , "hazard_insects"   , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RRR", "RqR", "RlR", 'R', foil.dat(ANY.Rubber)));
		ArmorsGT.HAZMATS_INSECTS    .add(ArmorsGT.HAZMAT_INSECTS    [3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.boots"    , "Защитные сапоги от насекомых"           , "Полный набор защищает от любых насекомых"       , "hazard_insects"   , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RlR", "RqR"       , 'R', foil.dat(ANY.Rubber)));

		ArmorsGT.HAZMATS_FROST      .add(ArmorsGT.HAZMAT_FROST      [0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.head"      , "Защитная маска от низких температур"    , "Полный комплект защищает от низких температур"  , "hazard_frost"     , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "AAA", "AGA", "q l", 'A', plate.dat(MT.Asbestos), 'G', ST.make(Blocks.stained_glass_pane, 1, 15-DYE_INDEX_Black)));
		ArmorsGT.HAZMATS_FROST      .add(ArmorsGT.HAZMAT_FROST      [1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.chest"     , "Защитная рубашка от низких температур"  , "Полный комплект защищает от низких температур"  , "hazard_frost"     , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "AqA", "AAA", "AAA", 'A', plate.dat(MT.Asbestos)));
		ArmorsGT.HAZMATS_FROST      .add(ArmorsGT.HAZMAT_FROST      [2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.legs"      , "Защитные штаны от низких температур"    , "Полный комплект защищает от низких температур"  , "hazard_frost"     , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "AAA", "AqA", "AlA", 'A', plate.dat(MT.Asbestos)));
		ArmorsGT.HAZMATS_FROST      .add(ArmorsGT.HAZMAT_FROST      [3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.boots"     , "Защитные сапоги от низких температур"   , "Полный комплект защищает от низких температур"  , "hazard_frost"     , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "AlA", "AqA"       , 'A', plate.dat(MT.Asbestos)));

		ArmorsGT.HAZMATS_HEAT       .add(ArmorsGT.HAZMAT_HEAT       [0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.heat.head"       , "Защитная маска от высоких температур"   , "Полный комплект защищает от высоких температур" , "hazard_heat"      , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, T, F, "FFF", "FGF", "x l", 'F', foil.dat(MT.Al), 'G', ST.make(Blocks.stained_glass_pane, 1, 15-DYE_INDEX_Black)));
		ArmorsGT.HAZMATS_HEAT       .add(ArmorsGT.HAZMAT_HEAT       [1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.heat.chest"      , "Защитная рубашка от высоких температур" , "Полный комплект защищает от высоких температур" , "hazard_heat"      , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, T, F, "FxF", "FFF", "FFF", 'F', foil.dat(MT.Al)));
		ArmorsGT.HAZMATS_HEAT       .add(ArmorsGT.HAZMAT_HEAT       [2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.heat.legs"       , "Защитные штаны от высоких температур"   , "Полный комплект защищает от высоких температур" , "hazard_heat"      , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, T, F, "FFF", "FxF", "FlF", 'F', foil.dat(MT.Al)));
		ArmorsGT.HAZMATS_HEAT       .add(ArmorsGT.HAZMAT_HEAT       [3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.heat.boots"      , "Защитные сапоги от высоких температур"  , "Полный комплект защищает от высоких температур" , "hazard_heat"      , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, T, F, "FlF", "FxF"       , 'F', foil.dat(MT.Al)));

		ArmorsGT.HAZMATS_RADIOACTIVE.add(ArmorsGT.HAZMAT_RADIOACTIVE[0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.head"  , "Защитная маска от радиации"             , "Полный комплект защищает от радиации"           , "hazard_radiation" , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LLL", "LGL", "x l", 'L', plate.dat(MT.Pb), 'G', Blocks.glass_pane));
		ArmorsGT.HAZMATS_RADIOACTIVE.add(ArmorsGT.HAZMAT_RADIOACTIVE[1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.chest" , "Защитная рубашка от радиации"           , "Полный комплект защищает от радиации"           , "hazard_radiation" , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LxL", "LLL", "LLL", 'L', plate.dat(MT.Pb)));
		ArmorsGT.HAZMATS_RADIOACTIVE.add(ArmorsGT.HAZMAT_RADIOACTIVE[2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.legs"  , "Защитные штаны от радиации"             , "Полный комплект защищает от радиации"           , "hazard_radiation" , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LLL", "LxL", "LlL", 'L', plate.dat(MT.Pb)));
		ArmorsGT.HAZMATS_RADIOACTIVE.add(ArmorsGT.HAZMAT_RADIOACTIVE[3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.boots" , "Защитные сапоги от радиации"            , "Полный комплект защищает от радиации"           , "hazard_radiation" , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LlL", "LxL"       , 'L', plate.dat(MT.Pb)));

		ArmorsGT.HAZMAT_BIOCHEMGAS [0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.head" , "Защитная маска от химикатов и газов"    , "Полный набор защищает от химикатов и газов"     , "hazard_biochemgas", 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RRR", "RGR", "q l", 'R', plate.dat(ANY.Rubber), 'G', Blocks.glass_pane);
		ArmorsGT.HAZMAT_BIOCHEMGAS [1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.chest", "Защитная рубашка от химикатов и газов"  , "Полный набор защищает от химикатов и газов"     , "hazard_biochemgas", 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RqR", "RRR", "RRR", 'R', plate.dat(ANY.Rubber));
		ArmorsGT.HAZMAT_BIOCHEMGAS [2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.legs" , "Защитные штаны от химикатов и газов"    , "Полный набор защищает от химикатов и газов"     , "hazard_biochemgas", 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RRR", "RqR", "RlR", 'R', plate.dat(ANY.Rubber));
		ArmorsGT.HAZMAT_BIOCHEMGAS [3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.boots", "Защитные сапоги от химикатов и газов"   , "Полный набор защищает от химикатов и газов"     , "hazard_biochemgas", 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RlR", "RqR"       , 'R', plate.dat(ANY.Rubber));

		ArmorsGT.HAZMAT_UNIVERSAL  [0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.head"  , "Универсальная защитная маска"           , "Полный набор защищает от всех опасностей"       , "hazard_universal" , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', ST.make(ArmorsGT.HAZMAT_BIOCHEMGAS[0], 1, 0), 'B', ST.make(ArmorsGT.HAZMAT_INSECTS[0], 1, 0), 'C', ST.make(ArmorsGT.HAZMAT_FROST[0], 1, 0), 'D', ST.make(ArmorsGT.HAZMAT_HEAT[0], 1, 0), 'E', ST.make(ArmorsGT.HAZMAT_RADIOACTIVE[0], 1, 0), 'F', ST.make(Items.chainmail_helmet    , 1, 0));
		ArmorsGT.HAZMAT_UNIVERSAL  [1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.chest" , "Универсальная защитная рубашка"         , "Полный набор защищает от всех опасностей"       , "hazard_universal" , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', ST.make(ArmorsGT.HAZMAT_BIOCHEMGAS[1], 1, 0), 'B', ST.make(ArmorsGT.HAZMAT_INSECTS[1], 1, 0), 'C', ST.make(ArmorsGT.HAZMAT_FROST[1], 1, 0), 'D', ST.make(ArmorsGT.HAZMAT_HEAT[1], 1, 0), 'E', ST.make(ArmorsGT.HAZMAT_RADIOACTIVE[1], 1, 0), 'F', ST.make(Items.chainmail_chestplate, 1, 0));
		ArmorsGT.HAZMAT_UNIVERSAL  [2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.legs"  , "Универсальные защитные штаны"           , "Полный набор защищает от всех опасностей"       , "hazard_universal" , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', ST.make(ArmorsGT.HAZMAT_BIOCHEMGAS[2], 1, 0), 'B', ST.make(ArmorsGT.HAZMAT_INSECTS[2], 1, 0), 'C', ST.make(ArmorsGT.HAZMAT_FROST[2], 1, 0), 'D', ST.make(ArmorsGT.HAZMAT_HEAT[2], 1, 0), 'E', ST.make(ArmorsGT.HAZMAT_RADIOACTIVE[2], 1, 0), 'F', ST.make(Items.chainmail_leggings  , 1, 0));
		ArmorsGT.HAZMAT_UNIVERSAL  [3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.universal.boots" , "Универсальные защитные сапоги"          , "Полный набор защищает от всех опасностей"       , "hazard_universal" , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, T, T, "AlB", "CqD", "ExF", 'A', ST.make(ArmorsGT.HAZMAT_BIOCHEMGAS[3], 1, 0), 'B', ST.make(ArmorsGT.HAZMAT_INSECTS[3], 1, 0), 'C', ST.make(ArmorsGT.HAZMAT_FROST[3], 1, 0), 'D', ST.make(ArmorsGT.HAZMAT_HEAT[3], 1, 0), 'E', ST.make(ArmorsGT.HAZMAT_RADIOACTIVE[3], 1, 0), 'F', ST.make(Items.chainmail_boots     , 1, 0));
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SWORD                     , "Меч"                                     , ""                                                              , new GT_Tool_Sword()                                            .setMaterialAmount(toolHeadSword                     .mAmount), OreDictToolNames.sword, OreDictToolNames.blade                                                                                           , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.TELUM         , 4)                                                                ), TOOL_sword);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.PICKAXE                   , "Кирка"                                   , ""                                                              , new GT_Tool_Pickaxe()                                          .setMaterialAmount(toolHeadPickaxe                   .mAmount), OreDictToolNames.pickaxe                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SHOVEL                    , "Лопата"                                  , ""                                                              , new GT_Tool_Shovel()                                           .setMaterialAmount(toolHeadShovel                    .mAmount), OreDictToolNames.shovel                                                                                                                  , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_shovel);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SPADE                     , "Совковая лопата"                         , "для снега, травы, мицелия, подзола, грязи и глины"             , new GT_Tool_Spade()                                            .setMaterialAmount(toolHeadSpade                     .mAmount), OreDictToolNames.shovel                                                                                                                  , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_shovel);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.AXE                       , "Топор"                                   , "Быстрее на бревнах. Вырубает целые деревья."                   , new GT_Tool_Axe()                                              .setMaterialAmount(toolHeadAxe                       .mAmount), OreDictToolNames.axe                                                                                                                     , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_axe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.DOUBLE_AXE                , "Секира"                                  , "Вырубает целые деревья и имеет низкую скорость атаки"          , new GT_Tool_AxeDouble()                                        .setMaterialAmount(toolHeadAxeDouble                 .mAmount), OreDictToolNames.axe                                                                                                                     , TC.stack(TC.INSTRUMENTUM  , 3), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_axe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.HOE                       , "Мотыга"                                  , ""                                                              , new GT_Tool_Hoe()                                              .setMaterialAmount(toolHeadHoe                       .mAmount), OreDictToolNames.hoe                                                                                                                     , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.MESSIS        , 2)                                ), TOOL_hoe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SAW                       , "Пила"                                    , "Быстрее на досках. Медленнее на бревнах. Можно собирать Лед."  , new GT_Tool_Saw()                                              .setMaterialAmount(toolHeadSaw                       .mAmount), OreDictToolNames.saw                                                                                                                     , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_saw);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.HARDHAMMER                , "Молот"                                   , "Дробит руду, а не собирает её"                                 , new GT_Tool_HardHammer()                                       .setMaterialAmount(toolHeadHammer                    .mAmount), OreDictToolNames.hammer                                                                                                                  , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_hammer);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SOFTHAMMER                , "Киянка"                                  , "Может вращать ванильные вещи и переключать лампы/рельсы."      , new GT_Tool_SoftHammer()                                       .setMaterialAmount(toolHeadHammer                    .mAmount), OreDictToolNames.softhammer                                                                                                              , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.LIMUS         , 4)                                                                ), TOOL_softhammer);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH                    , "Гаечный ключ"                            , "Удерживайте ЛКМ, чтобы демонтировать машины"                   , new GT_Tool_Wrench()                                           .setMaterialAmount(6*U                                       ), OreDictToolNames.wrench                                                                                                                  , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.MACHINA       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_wrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.FILE                      , "Напильник"                               , "Собирает железные прутья и похожие предметы быстрее"           , new GT_Tool_File()                                             .setMaterialAmount(toolHeadFile                      .mAmount), OreDictToolNames.file                                                                                                                    , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_file);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CROWBAR                   , "Монтировка"                              , "Собирает все, что нельзя собрать по-другому"                   , new GT_Tool_Crowbar()                                          .setMaterialAmount(3*U2                                      ), OreDictToolNames.crowbar                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.TELUM         , 2)                                ), TOOL_crowbar);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SCREWDRIVER               , "Отвертка"                                , ""                                                              , new GT_Tool_Screwdriver()                                      .setMaterialAmount(toolHeadScrewdriver               .mAmount), OreDictToolNames.screwdriver                                                                                                             , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_screwdriver);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CLUB                      , "Дубина"                                  , "Тупое примитивное оружие и камнедробилка"                      , new GT_Tool_Club()                                             .setMaterialAmount(6*U                                       )                                                                                                                                           , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.HUMANUS       , 2), TC.stack(TC.STRONTIO      , 2)                                ), TOOL_hammer);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WIRECUTTER                , "Кусачки"                                 , "Собирает кабели и провода быстрее"                             , new GT_Tool_WireCutter()                                       .setMaterialAmount(4*U                                       ), OreDictToolNames.wirecutter                                                                                                              , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_cutter);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SCOOP                     , "Сачок"                                   , ""                                                              , new GT_Tool_Scoop()                                            .setMaterialAmount(3*U                                       ), OreDictToolNames.scoop                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.BESTIA        , 2), TC.stack(TC.PANNUS        , 2)                                ), TOOL_scoop);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.BRANCHCUTTER              , "Секатор"                                 , ""                                                              , new GT_Tool_BranchCutter()                                     .setMaterialAmount(5*U                                       ), OreDictToolNames.branchcutter                                                                                                            , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.HERBA         , 2)                                ), TOOL_grafter);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.UNIVERSALSPADE            , "Универсальная лопата"                    , ""                                                              , new GT_Tool_UniversalSpade()                                   .setMaterialAmount(toolHeadUniversalSpade            .mAmount), OreDictToolNames.blade, OreDictToolNames.shovel, OreDictToolNames.crowbar, OreDictToolNames.saw                                          , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.TELUM         , 1), TC.stack(TC.METO          , 1), TC.stack(TC.FABRICO       , 1)), TOOL_crowbar);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.KNIFE                     , "Нож"                                     , ""                                                              , new GT_Tool_Knife()                                            .setMaterialAmount(1*U                                       ), OreDictToolNames.blade, OreDictToolNames.knife, OreDictToolNames.hac_cuttingboard                                                        , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.TELUM         , 2), TC.stack(TC.CORPUS        , 2)                                ), TOOL_knife);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.BUTCHERYKNIFE             , "Тесак"                                   , "Имеет низкую скорость атаки"                                   , new GT_Tool_ButcheryKnife()                                    .setMaterialAmount(4*U                                       ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.CORPUS        , 4)                                ), TOOL_knife);
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                           .setMaterialAmount(3*U                                       ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SENSE                     , "Коса"                                    , "Собирает урожай"                                               , new GT_Tool_Sense()                                            .setMaterialAmount(toolHeadSense                     .mAmount), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.HERBA         , 2), TC.stack(TC.MORTUUS       , 2)), TOOL_sense);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.PLOW                      , "Снегоуборочная лопата"                   , "Используется для уборки снега"                                 , new GT_Tool_Plow()                                             .setMaterialAmount(toolHeadPlow                      .mAmount), OreDictToolNames.plow                                                                                                                    , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GELUM         , 2)                                ), TOOL_plow);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.PLUNGER                   , "Вантуз"                                  , "Не так хорошо чистит трубы, как пылающие цветы."               , new GT_Tool_Plunger()                                          .setMaterialAmount(0                                         ), OreDictToolNames.plunger                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.VACUOS        , 2), TC.stack(TC.ITER          , 2)                                ), TOOL_plunger);
		ToolsGT.sMetaTool.addTool(ToolsGT.ROLLING_PIN               , "Скалка"                                  , ""                                                              , new GT_Tool_RollingPin()                                       .setMaterialAmount(2*U                                       ), OreDictToolNames.rollingpin                                                                                                              , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.LIMUS         , 4)                                                                );
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CHISEL                    , "Долото"                                  , "Будьте осторожны на серверах - ПИНГ!"                          , new GT_Tool_Chisel()                                           .setMaterialAmount(toolHeadChisel                    .mAmount), OreDictToolNames.chisel                                                                                                                  , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.PERMUTATIO    , 1), TC.stack(TC.PERDITIO      , 1)                                ), TOOL_chisel);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.FLINT_AND_TINDER          , "Огниво"                                  , ""                                                              , new GT_Tool_FlintAndTinder()                                   .setMaterialAmount(0                                         ), OreDictToolNames.flintandtinder, OD.craftingFirestarter                                                                                  , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.IGNIS         , 2)                                                                ), TOOL_igniter);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH             , "Разводной ключ"                          , "Удерживайте ЛКМ, чтобы демонтировать машины"                   , new GT_Tool_MonkeyWrench()                                     .setMaterialAmount(6*U                                       ), OreDictToolNames.monkeywrench, OreDictToolNames.wrench                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.MACHINA       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_monkeywrench);
		ToolsGT.sMetaTool.addTool(ToolsGT.BENDING_CYLINDER          , "Гибочный цилиндр"                        , ""                                                              , new GT_Tool_BendingCylinder()                                  .setMaterialAmount(6*U                                       ), OreDictToolNames.bendingcylinder                                                                                                         , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METALLUM      , 4)                                                                );
		ToolsGT.sMetaTool.addTool(ToolsGT.BENDING_CYLINDER_SMALL    , "Малый гибочный цилиндр"                  , ""                                                              , new GT_Tool_BendingCylinderSmall()                             .setMaterialAmount(3*U                                       ), OreDictToolNames.bendingcylindersmall                                                                                                    , TC.stack(TC.INSTRUMENTUM  , 1), TC.stack(TC.METALLUM      , 2)                                                                );
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CONSTRUCTION_PICK         , "Строительная кирка"                      , "Хорошо для кирпичей и т.д., ужасно для добычи"                 , new GT_Tool_PickaxeConstruction()                              .setMaterialAmount(toolHeadConstructionPickaxe       .mAmount), OreDictToolNames.pickaxe                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 3), TC.stack(TC.PERFODIO      , 3)                                                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MAGNIFYING_GLASS          , "Лупа"                                    , "Сделано из палки и линзы"                                      , new GT_Tool_MagnifyingGlass()                                  .setMaterialAmount(lens                              .mAmount), OreDictToolNames.magnifyingglass                                                                                                         , TC.stack(TC.INSTRUMENTUM  , 1), TC.stack(TC.SENSUS        , 2)                                                                ), TOOL_magnifyingglass);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SCISSORS                  , "Ножницы"                                 , "Не бегайте с ними в руках!"                                    , new GT_Tool_Scissors()                                         .setMaterialAmount(U*2+screw.mAmount+2*ring          .mAmount), OreDictToolNames.scissors, OreDictToolNames.shears                                                                                       , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.TELUM         , 2), TC.stack(TC.PANNUS        , 2)                                ), TOOL_scissors);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.PINCERS                   , "Клещи"                                   , ""                                                              , new GT_Tool_Pincers()                                          .setMaterialAmount(U*2+screw.mAmount+2*stick         .mAmount), OreDictToolNames.pincers                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 4), TC.stack(TC.FABRICO       , 2)                                                                ), TOOL_pincers);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.GEM_PICK                  , "Кирка с напылением"                      , "Половина прочности кирки из самоцыетов"                        , new GT_Tool_PickaxeGem()                                       .setMaterialAmount(toolHeadPickaxeGem                .mAmount), OreDictToolNames.pickaxe                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 3), TC.stack(TC.PERFODIO      , 3)                                                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.HAND_DRILL                , "Ручная дрель"                            , ""                                                              , new GT_Tool_HandDrill()                                        .setMaterialAmount(toolHeadArrow.mAmount+2*bolt      .mAmount), OreDictToolNames.handdrill                                                                                                               , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.PERFODIO      , 1)                                                                ), TOOL_drill);
		ToolsGT.sMetaTool.addTool(ToolsGT.BUILDERWAND               , "Строительный жезл"                       , ""                                                              , new GT_Tool_Builderwand()                                      .setMaterialAmount(toolHeadBuilderwand               .mAmount)                                                                                                                                           , TC.stack(TC.INSTRUMENTUM  , 1), TC.stack(TC.ORDO          , 1), TC.stack(TC.PRAECANTIO    , 1)                                );


		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MININGDRILL_LV            , "Шахтерский бур (LV)"                     , ""                                                              , new GT_Tool_MiningDrill_LV()                                   .setMaterialAmount(toolHeadDrill                     .mAmount), OreDictToolNames.miningdrill                                                                                                             , TC.stack(TC.MACHINA       , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MININGDRILL_MV            , "Шахтерский бур (MV)"                     , ""                                                              , new GT_Tool_MiningDrill_MV()                                   .setMaterialAmount(toolHeadDrill                     .mAmount), OreDictToolNames.miningdrill                                                                                                             , TC.stack(TC.MACHINA       , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MININGDRILL_HV            , "Шахтерский бур (HV)"                     , ""                                                              , new GT_Tool_MiningDrill_HV()                                   .setMaterialAmount(toolHeadDrill                     .mAmount), OreDictToolNames.miningdrill                                                                                                             , TC.stack(TC.MACHINA       , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CHAINSAW_LV               , "Электропила (LV)"                        , "Можно также собирать лед"                                      , new GT_Tool_Chainsaw_LV()                                      .setMaterialAmount(toolHeadChainsaw                  .mAmount), OreDictToolNames.saw                                                                                                                     , TC.stack(TC.MACHINA       , 2), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_saw);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CHAINSAW_MV               , "Электропила (MV)"                        , "Можно также собирать лед"                                      , new GT_Tool_Chainsaw_MV()                                      .setMaterialAmount(toolHeadChainsaw                  .mAmount), OreDictToolNames.saw                                                                                                                     , TC.stack(TC.MACHINA       , 2), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_saw);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CHAINSAW_HV               , "Электропила (HV)"                        , "Можно также собирать лед"                                      , new GT_Tool_Chainsaw_HV()                                      .setMaterialAmount(toolHeadChainsaw                  .mAmount), OreDictToolNames.saw                                                                                                                     , TC.stack(TC.MACHINA       , 2), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_saw);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH_LV                 , "Электроключ (LV)"                        , "Нажмите ПКМ, чтобы переключиться на разводной ключ"            , new GT_Tool_Wrench_LV(ToolsGT.MONKEY_WRENCH_LV)                .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.wrench, OreDictToolNames.wrench                                                                                         , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_wrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH_MV                 , "Электроключ (MV)"                        , "Нажмите ПКМ, чтобы переключиться на разводной ключ"            , new GT_Tool_Wrench_MV(ToolsGT.MONKEY_WRENCH_MV)                .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.wrench, OreDictToolNames.wrench                                                                                         , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_wrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH_HV                 , "Электроключ (HV)"                        , "Нажмите ПКМ, чтобы переключиться на разводной ключ"            , new GT_Tool_Wrench_HV(ToolsGT.MONKEY_WRENCH_HV)                .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.wrench, OreDictToolNames.wrench                                                                                         , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_wrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.JACKHAMMER_HV_Normal      , "Отбойный молоток (HV, Нормальный режим)" , "Разбивает камень на куски"                                     , new GT_Tool_JackHammer_HV_Normal(ToolsGT.JACKHAMMER_HV_No_Ores).setMaterialAmount(3*U2                                      ), OreDictToolNames.jackhammer                                                                                                              , TC.stack(TC.MACHINA       , 2), TC.stack(TC.PERFODIO      , 2), TC.stack(TC.PERDITIO      , 2)                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.JACKHAMMER_HV_No_Ores     , "Отбойный молоток (HV, Режим без руд)"    , "Не разрушает рудные блоки, кроме слоистых руд"                 , new GT_Tool_JackHammer_HV_No_Ores(ToolsGT.JACKHAMMER_HV_Normal).setMaterialAmount(3*U2                                      ), OreDictToolNames.jackhammer                                                                                                              , TC.stack(TC.MACHINA       , 2), TC.stack(TC.PERFODIO      , 2), TC.stack(TC.PERDITIO      , 2)                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.BUZZSAW_LV                , "Циркулярная пила (LV)"                   , "Не подходит для уборки блоков"                                 , new GT_Tool_BuzzSaw_LV()                                       .setMaterialAmount(toolHeadBuzzSaw                   .mAmount), OreDictToolNames.saw                                                                                                                     , TC.stack(TC.MACHINA       , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_saw);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SCREWDRIVER_LV            , "Электроотвертка (LV)"                    , ""                                                              , new GT_Tool_Screwdriver_LV()                                   .setMaterialAmount(toolHeadScrewdriver               .mAmount), OreDictToolNames.screwdriver                                                                                                             , TC.stack(TC.MACHINA       , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_screwdriver);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.DRILL_LV                  , "Дрель (LV)"                              , ""                                                              , new GT_Tool_Drill_LV()                                         .setMaterialAmount(stick                             .mAmount), OreDictToolNames.drill, OreDictToolNames.handdrill                                                                                       , TC.stack(TC.MACHINA       , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.PERFODIO      , 1)                                ), TOOL_drill);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MIXER_LV                  , "Миксер (LV)"                             , "Позволяет не тратить голод, работая с миской для смешивания"   , new GT_Tool_Mixer_LV()                                         .setMaterialAmount(3*U2                                      ), OreDictToolNames.mixer                                                                                                                   , TC.stack(TC.MACHINA       , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.PERMUTATIO    , 1)                                ), TOOL_mixer);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH_LV          , "Разводной электроключ (LV)"              , "Нажмите ПКМ, чтобы переключиться на гаечный ключ"              , new GT_Tool_MonkeyWrench_LV(ToolsGT.WRENCH_LV)                 .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.monkeywrench, OreDictToolNames.wrench                                                                                   , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_monkeywrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH_MV          , "Разводной электроключ (MV)"              , "Нажмите ПКМ, чтобы переключиться на гаечный ключ"              , new GT_Tool_MonkeyWrench_MV(ToolsGT.WRENCH_MV)                 .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.monkeywrench, OreDictToolNames.wrench                                                                                   , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_monkeywrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH_HV          , "Разводной электроключ (HV)"              , "Нажмите ПКМ, чтобы переключиться на гаечный ключ"              , new GT_Tool_MonkeyWrench_HV(ToolsGT.WRENCH_HV)                 .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.monkeywrench, OreDictToolNames.wrench                                                                                   , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_monkeywrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.TRIMMER_LV                , "Тример (LV)"                             , ""                                                              , new GT_Tool_Trimmer_LV()                                       .setMaterialAmount(2*toolHeadSword                   .mAmount), OreDictToolNames.branchcutter                                                                                                            , TC.stack(TC.MACHINA       , 2), TC.stack(TC.METO          , 2), TC.stack(TC.HERBA         , 2)                                ), TOOL_grafter);

		ToolsGT.sMetaTool.addTool(ToolsGT.POCKET_MULTITOOL          , "Карманный мультиинструмент"              , "7 полезных инструментов в одном!"                              , new GT_Tool_Pocket_Multitool(ToolsGT.POCKET_KNIFE)             .setMaterialAmount(199*U18                                   )                                                                                                                                           , TC.stack(TC.INSTRUMENTUM  , 6), TC.stack(TC.FABRICO       , 3), TC.stack(TC.ORDO          , 3)                                );
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.POCKET_KNIFE              , "Карманный мультиинструмент (Нож)"        , ""                                                              , new GT_Tool_Pocket_Knife(ToolsGT.POCKET_SAW)                   .setMaterialAmount(199*U18                                   ), OreDictToolNames.blade, OreDictToolNames.knife, OreDictToolNames.hac_cuttingboard                                                        , TC.stack(TC.INSTRUMENTUM  , 6), TC.stack(TC.FABRICO       , 3), TC.stack(TC.ORDO          , 3)                                ), TOOL_knife);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.POCKET_SAW                , "Карманный мультиинструмент (Пила)"       , "Быстрее на досках. Медленнее на бревнах. Можно собирать Лед."  , new GT_Tool_Pocket_Saw(ToolsGT.POCKET_FILE)                    .setMaterialAmount(199*U18                                   ), OreDictToolNames.saw                                                                                                                     , TC.stack(TC.INSTRUMENTUM  , 6), TC.stack(TC.FABRICO       , 3), TC.stack(TC.ORDO          , 3)                                ), TOOL_saw);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.POCKET_FILE               , "Карманный мультиинструмент (Напильник)"  , "Собирает железные прутья и похожие предметы быстрее"           , new GT_Tool_Pocket_File(ToolsGT.POCKET_SCREWDRIVER)            .setMaterialAmount(199*U18                                   ), OreDictToolNames.file                                                                                                                    , TC.stack(TC.INSTRUMENTUM  , 6), TC.stack(TC.FABRICO       , 3), TC.stack(TC.ORDO          , 3)                                ), TOOL_file);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.POCKET_SCREWDRIVER        , "Карманный мультиинструмент (Отвертка)"   , ""                                                              , new GT_Tool_Pocket_Screwdriver(ToolsGT.POCKET_WIRECUTTER)      .setMaterialAmount(199*U18                                   ), OreDictToolNames.screwdriver                                                                                                             , TC.stack(TC.INSTRUMENTUM  , 6), TC.stack(TC.FABRICO       , 3), TC.stack(TC.ORDO          , 3)                                ), TOOL_screwdriver);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.POCKET_WIRECUTTER         , "Карманный мультиинструмент (Кусачки)"    , "Собирает кабели и провода быстрее"                             , new GT_Tool_Pocket_Cutter(ToolsGT.POCKET_SCISSORS)             .setMaterialAmount(199*U18                                   ), OreDictToolNames.wirecutter                                                                                                              , TC.stack(TC.INSTRUMENTUM  , 6), TC.stack(TC.FABRICO       , 3), TC.stack(TC.ORDO          , 3)                                ), TOOL_cutter);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.POCKET_SCISSORS           , "Карманный мультиинструмент (Ножницы)"    , "Не бегайте с ними в руках!"                                    , new GT_Tool_Pocket_Scissors(ToolsGT.POCKET_CHISEL)             .setMaterialAmount(199*U18                                   ), OreDictToolNames.scissors, OreDictToolNames.shears                                                                                       , TC.stack(TC.INSTRUMENTUM  , 6), TC.stack(TC.FABRICO       , 3), TC.stack(TC.ORDO          , 3)                                ), TOOL_scissors);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.POCKET_CHISEL             , "Карманный мультиинструмент (Долото)"     , "Будьте осторожны на серверах - ПИНГ!"                          , new GT_Tool_Pocket_Chisel(ToolsGT.POCKET_MULTITOOL)            .setMaterialAmount(199*U18                                   ), OreDictToolNames.chisel                                                                                                                  , TC.stack(TC.INSTRUMENTUM  , 6), TC.stack(TC.FABRICO       , 3), TC.stack(TC.ORDO          , 3)                                ), TOOL_chisel);
		...
		ToolsGT.sMetaTool.addTool(ToolsGT.PISTOL , APRIL_FOOLS?"Small Crossbow" :"Пистолет" , "Один выстрел, умеренный урон", new GT_Tool_Pistol ().setMaterialAmount(U9*19), TC.stack(TC.TELUM, 6), TC.stack(TC.FABRICO, 3), TC.stack(TC.IGNIS, 3));
		ToolsGT.sMetaTool.addTool(ToolsGT.CARBINE, APRIL_FOOLS?"Medium Crossbow":"Карабин"  , "Один выстрел, Большой урон"  , new GT_Tool_Carbine().setMaterialAmount(U9*19), TC.stack(TC.TELUM, 7), TC.stack(TC.FABRICO, 4), TC.stack(TC.IGNIS, 4));
		ToolsGT.sMetaTool.addTool(ToolsGT.RIFLE  , APRIL_FOOLS?"Big Crossbow"   :"Винтовка" , "Один выстрел, Массивный урон", new GT_Tool_Rifle  ().setMaterialAmount(U9*28), TC.stack(TC.TELUM, 8), TC.stack(TC.FABRICO, 5), TC.stack(TC.IGNIS, 5));
