...
public class MultiItemTechnological extends MultiItemRandomWithCompat {
	...
	public void addItems() {
		...
		IL.Cover_Logistics_Fluid_Import          .set(addItem(tLastID =  1091, "огический фильтр шины импорта (Жидкость)"  , "Для использования с ядрами логистики и проводкой"         , CoverLogisticsFluidImport.INSTANCE                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
