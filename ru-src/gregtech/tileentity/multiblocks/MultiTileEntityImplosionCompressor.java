...
public class MultiTileEntityImplosionCompressor extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.implosioncompressor.1", "Полая 3x3x3 из 25 прочных стен из вольфрамовой стали и наполненная воздухом");
		LH.add("gt.tooltip.multiblock.implosioncompressor.2", "Главный блок распологается по центру сбоку снизу и направлен наружу");
	}
