...
public abstract class MultiTileEntityTank5x5x5 extends MultiTileEntityTank {
	static {
		LH.add("gt.tooltip.multiblock.tank5x5x5.1", "5x5x5 полая из стен из того же материала, что и главный блок");
		LH.add("gt.tooltip.multiblock.tank5x5x5.2", "Этот блок распологается по центру снизу/сверху/сбоку и направлен наружу");
		LH.add("gt.tooltip.multiblock.tank5x5x5.3", "Автоматически выводит содержимое, если не влияет гравитация");
	}
