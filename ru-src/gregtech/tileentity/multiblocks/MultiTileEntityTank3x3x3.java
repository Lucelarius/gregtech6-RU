...
public abstract class MultiTileEntityTank3x3x3 extends MultiTileEntityTank {
	static {
		LH.add("gt.tooltip.multiblock.tank3x3x3.1", "3x3x3 полая из стен из того же материала, что и главный блок");
		LH.add("gt.tooltip.multiblock.tank3x3x3.2", "Этот блок распологается по центру снизу/сверху/сбоку и направлен наружу");
		LH.add("gt.tooltip.multiblock.tank3x3x3.3", "Автоматически выводит содержимое, если не влияет гравитация");
	}
