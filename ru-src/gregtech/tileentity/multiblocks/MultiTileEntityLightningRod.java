...
public class MultiTileEntityLightningRod extends TileEntityBase10MultiBlockBase implements ITileEntityEnergy, ITileEntityEnergyDataCapacitor, IMultiBlockEnergy {
	...
	static {
		LH.add("gt.tooltip.multiblock.lightningrod.1", "Нижняя: 3x3 из вольфрамовых стен и главного блока в центре");
		LH.add("gt.tooltip.multiblock.lightningrod.2", "Потом: Полная 3х3 из больших ниобий-титановых катушек");
		LH.add("gt.tooltip.multiblock.lightningrod.3", "Потом: Полная 3x3 из вольфрамовых стен");
		LH.add("gt.tooltip.multiblock.lightningrod.4", "Потом: Полная 3х3 из больших ниобий-титановых катушек");
		LH.add("gt.tooltip.multiblock.lightningrod.5", "Верхняя: Полная 3x3 из вольфрамовых стен");
		LH.add("gt.tooltip.multiblock.lightningrod.6", "По центру: 1x1 столб из стержней молниеотвода");
		LH.add("gt.tooltip.multiblock.lightningrod.7", "Для работы, стержень должен достигать высоты 100 блоков или выше");
		LH.add("gt.tooltip.multiblock.lightningrod.8", "Оптимальная эффективность при длине стержня 100м");
		LH.add("gt.tooltip.multiblock.lightningrod.9", "Снижение эффективности, если слишком близко к другому молниеотводу (256м)");
	}
	...
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		...
		aList.add(Chat.GREEN    + LH.get(LH.ENERGY_OUTPUT) + ": " + Chat.WHITE + VREC[6] + " " + mEnergyTypeEmitted.getLocalisedChatNameShort() + Chat.WHITE + "/p (до 16 Ампер)");
		aList.add(Chat.WHITE    + mCapacity + " " + mEnergyTypeEmitted.getLocalisedChatNameShort() + Chat.GRAY + " за удар молнии");
