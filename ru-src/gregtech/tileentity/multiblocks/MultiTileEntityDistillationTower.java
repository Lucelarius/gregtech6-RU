...
public class MultiTileEntityDistillationTower extends TileEntityBase10MultiBlockMachine {
	...
	static {
		LH.add("gt.tooltip.multiblock.distillationtower.1", "3x3 Основа из теплопередатчиков");
		LH.add("gt.tooltip.multiblock.distillationtower.2", "3x3x8 из частей ректификационной колонны");
		LH.add("gt.tooltip.multiblock.distillationtower.3", "Главный блок распологается по центру сбоку снизу и направлен наружу");
		LH.add("gt.tooltip.multiblock.distillationtower.4", "Вывод автоматический на задней стороне");
		LH.add("gt.tooltip.multiblock.distillationtower.5", "Нижнее отверстие предназначено для вывода предметов");
		LH.add("gt.tooltip.multiblock.distillationtower.6", "Подача возможна только в нижнем слое башни");
	}
