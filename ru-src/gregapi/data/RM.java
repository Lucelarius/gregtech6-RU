...
public class RM {
	public static final RecipeMap
	  DidYouKnow                = new RecipeMap                     (null, "gt.recipe.other"                        , "Вы знали...?"               , null, 0, 1, RES_PATH_GUI+"machines/Default"                   ,/*IN-OUT-MIN-ITEM=*/ 6, 6, 0,/*IN-OUT-MIN-FLUID=*/ 3, 3, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , F, T, F, F, F, F, F), Other = DidYouKnow
	, Autocrafter               = new RecipeMapAutocrafting         (null, "gt.recipe.autocrafting"                 , "Крафт"                      , null, 0, 1, RES_PATH_GUI+"machines/Crafting"                  ,/*IN-OUT-MIN-ITEM=*/ 9,12, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, F, F, T, F, T, T)
	
	, DistillationTower         = new RecipeMap                     (null, "gt.recipe.distillationtower"            , "Ректиф. колонна"            , null, 0, 1, RES_PATH_GUI+"machines/DistillationTower"         ,/*IN-OUT-MIN-ITEM=*/ 1, 3, 0,/*IN-OUT-MIN-FLUID=*/ 1, 9, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, F, F)
	, CryoDistillationTower     = new RecipeMap                     (null, "gt.recipe.cryodistillationtower"        , "Крио-Ректиф. колонна"       , null, 0, 1, RES_PATH_GUI+"machines/CryoDistillationTower"     ,/*IN-OUT-MIN-ITEM=*/ 1, 3, 0,/*IN-OUT-MIN-FLUID=*/ 1, 9, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, F, F)
	, SteamCracking             = new RecipeMap                     (null, "gt.recipe.steamcracking"                , "Паровой крекер"             , null, 0, 1, RES_PATH_GUI+"machines/SteamCracking"             ,/*IN-OUT-MIN-ITEM=*/ 1, 3, 0,/*IN-OUT-MIN-FLUID=*/ 2, 9, 1,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, CatalyticCracking         = new RecipeMap                     (null, "gt.recipe.catalyticcracking"            , "Каталитический крекер"      , null, 0, 1, RES_PATH_GUI+"machines/CatalyticCracking"         ,/*IN-OUT-MIN-ITEM=*/ 1, 3, 0,/*IN-OUT-MIN-FLUID=*/ 2, 9, 1,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Fermenter                 = new RecipeMap                     (null, "gt.recipe.fermenter"                    , "Ферментер"                  , null, 0, 1, RES_PATH_GUI+"machines/Fermenter"                 ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 1, 1, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Distillery                = new RecipeMap                     (null, "gt.recipe.distillery"                   , "Дистилятор"                 , null, 0, 1, RES_PATH_GUI+"machines/Distillery"                ,/*IN-OUT-MIN-ITEM=*/ 1, 2, 1,/*IN-OUT-MIN-FLUID=*/ 1, 2, 1,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, F, F)
	, Drying                    = new RecipeMap                     (null, "gt.recipe.drying"                       , "Сушилка"                    , null, 0, 1, RES_PATH_GUI+"machines/Dryer"                     ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 0,/*IN-OUT-MIN-FLUID=*/ 1, 3, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Coagulator                = new RecipeMap                     (null, "gt.recipe.coagulator"                   , "Коагулятор"                 , null, 0, 1, RES_PATH_GUI+"machines/Coagulator"                ,/*IN-OUT-MIN-ITEM=*/ 0, 1, 0,/*IN-OUT-MIN-FLUID=*/ 1, 0, 1,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, CrystallisationCrucible   = new RecipeMap                     (null, "gt.recipe.crystallisationcrucible"      , "Кристаллизационный тигель"  , null, 0, 1, RES_PATH_GUI+"machines/CrystallisationCrucible"   ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 3, 0, 1,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Mixer                     = new RecipeMap                     (null, "gt.recipe.mixer"                        , "Миксер"                     , null, 0, 1, RES_PATH_GUI+"machines/Mixer"                     ,/*IN-OUT-MIN-ITEM=*/ 6, 1, 0,/*IN-OUT-MIN-FLUID=*/ 6, 2, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, HeatMixer                 = Mixer
	, BurnMixer                 = new RecipeMap                     (null, "gt.recipe.burnmixer"                    , "Смесительная горелка"       , null, 0, 1, RES_PATH_GUI+"machines/BurnMixer"                 ,/*IN-OUT-MIN-ITEM=*/ 6, 1, 0,/*IN-OUT-MIN-FLUID=*/ 6, 2, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, CryoMixer                 = new RecipeMap                     (null, "gt.recipe.cryomixer"                    , "Криомиксер"                 , null, 0, 1, RES_PATH_GUI+"machines/CryoMixer"                 ,/*IN-OUT-MIN-ITEM=*/ 6, 1, 0,/*IN-OUT-MIN-FLUID=*/ 6, 2, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, CokeOven                  = new RecipeMap                     (null, "gt.recipe.cokeoven"                     , "Коксовая печь"              , null, 0, 1, RES_PATH_GUI+"machines/CokeOven"                  ,/*IN-OUT-MIN-ITEM=*/ 1, 9, 1,/*IN-OUT-MIN-FLUID=*/ 0, 1, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Roasting                  = new RecipeMap                     (null, "gt.recipe.roaster"                      , "Окислительная печь"         , null, 0, 1, RES_PATH_GUI+"machines/Roaster"                   ,/*IN-OUT-MIN-ITEM=*/ 1, 3, 1,/*IN-OUT-MIN-FLUID=*/ 1, 1, 1,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Bath                      = new RecipeMapBath                 (null, "gt.recipe.bath"                         , "Ванна"                      , null, 0, 1, RES_PATH_GUI+"machines/Bath"                      ,/*IN-OUT-MIN-ITEM=*/ 6, 6, 1,/*IN-OUT-MIN-FLUID=*/ 1, 3, 1,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Sluice                    = new RecipeMap                     (null, "gt.recipe.sluice"                       , "Мойка"                      , null, 0, 1, RES_PATH_GUI+"machines/Sluice"                    ,/*IN-OUT-MIN-ITEM=*/ 1, 9, 1,/*IN-OUT-MIN-FLUID=*/ 1, 1, 1,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, MagneticSeparator         = new RecipeMap                     (null, "gt.recipe.magneticseparator"            , "Магнитный сепаратор"        , null, 0, 1, RES_PATH_GUI+"machines/MagneticSeparator"         ,/*IN-OUT-MIN-ITEM=*/ 1, 6, 0,/*IN-OUT-MIN-FLUID=*/ 1, 6, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Sifting                   = new RecipeMap                     (null, "gt.recipe.sifter"                       , "Просеиватель"               , null, 2, 1, RES_PATH_GUI+"machines/Sifter"                    ,/*IN-OUT-MIN-ITEM=*/ 1,12, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	
	, Calciner                  = new RecipeMap                     (null, "gt.recipe.calciner"                     , "Кальцинатор"                , null, 0, 1, RES_PATH_GUI+"machines/Calciner"                  ,/*IN-OUT-MIN-ITEM=*/ 3, 3, 0,/*IN-OUT-MIN-FLUID=*/ 3, 3, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, ImplosionCompressor       = new RecipeMap                     (null, "gt.recipe.implosioncompressor"          , "Детонационный компрессор"   , null, 0, 1, RES_PATH_GUI+"machines/ImplosionCompressor"       ,/*IN-OUT-MIN-ITEM=*/ 3, 3, 3,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Compressor                = new RecipeMap                     (null, "gt.recipe.compressor"                   , "Компрессор"                 , null, 0, 1, RES_PATH_GUI+"machines/Compressor"                ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Injector                  = new RecipeMap                     (null, "gt.recipe.injector"                     , "Инжектор"                   , null, 0, 1, RES_PATH_GUI+"machines/Injector"                  ,/*IN-OUT-MIN-ITEM=*/ 2, 1, 0,/*IN-OUT-MIN-FLUID=*/ 2, 1, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Loom                      = new RecipeMap                     (null, "gt.recipe.loom"                         , "Ткацкий станок"             , null, 0, 1, RES_PATH_GUI+"machines/Loom"                      ,/*IN-OUT-MIN-ITEM=*/ 6, 1, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Laminator                 = new RecipeMap                     (null, "gt.recipe.laminator"                    , "Ламинатор"                  , null, 0, 1, RES_PATH_GUI+"machines/Laminator"                 ,/*IN-OUT-MIN-ITEM=*/ 2, 1, 2,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Autoclave                 = new RecipeMap                     (null, "gt.recipe.autoclave"                    , "Автоклав"                   , null, 0, 1, RES_PATH_GUI+"machines/Autoclave"                 ,/*IN-OUT-MIN-ITEM=*/ 2, 3, 2,/*IN-OUT-MIN-FLUID=*/ 1, 1, 1,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Freezer                   = new RecipeMap                     (null, "gt.recipe.freezer"                      , "Морозилка"                  , null, 0, 1, RES_PATH_GUI+"machines/Freezer"                   ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 1, 1, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Polarizer                 = new RecipeMap                     (null, "gt.recipe.polarizer"                    , "Намагничиватель"            , null, 0, 1, RES_PATH_GUI+"machines/Polarizer"                 ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Lightning                 = new RecipeMap                     (null, "gt.recipe.lightning"                    , "Молекулярный зарядник"      , null, 0, 1, RES_PATH_GUI+"machines/Lightning"                 ,/*IN-OUT-MIN-ITEM=*/ 6, 6, 0,/*IN-OUT-MIN-FLUID=*/ 6, 6, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	
	, Slicer                    = new RecipeMap                     (null, "gt.recipe.slicer"                       , "Ломтерезка"                 , null, 0, 1, RES_PATH_GUI+"machines/Slicer"                    ,/*IN-OUT-MIN-ITEM=*/ 2, 2, 2,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Lathe                     = new RecipeMap                     (null, "gt.recipe.lathe"                        , "Токарный станок"            , null, 0, 1, RES_PATH_GUI+"machines/Lathe"                     ,/*IN-OUT-MIN-ITEM=*/ 1, 2, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, PressureWasher            = new RecipeMap                     (null, "gt.recipe.pressurewasher"               , "Мойка высокого давления"    , null, 0, 1, RES_PATH_GUI+"machines/PressureWasher"            ,/*IN-OUT-MIN-ITEM=*/ 1, 2, 1,/*IN-OUT-MIN-FLUID=*/ 1, 0, 1,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T), Debarker = PressureWasher
	, Press                     = new RecipeMapFormingPress         (null, "gt.recipe.press"                        , "Пресс"                      , null, 0, 1, RES_PATH_GUI+"machines/Press"                     ,/*IN-OUT-MIN-ITEM=*/ 3, 1, 2,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	...
	, Juicer                    = new RecipeMap                     (null, "gt.recipe.juicer"                       , "Соковыжималка"              , null, 0, 1, RES_PATH_GUI+"machines/Juicer"                    ,/*IN-OUT-MIN-ITEM=*/ 1, 2, 1,/*IN-OUT-MIN-FLUID=*/ 0, 1, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	...
	, ClusterMill               = new RecipeMap                     (null, "gt.recipe.clustermill"                  , "Многовал. прок. станок"     , null, 0, 1, RES_PATH_GUI+"machines/ClusterMill"               ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, RollingMill               = new RecipeMap                     (null, "gt.recipe.rollingmill"                  , "Прокатный станок"           , null, 0, 1, RES_PATH_GUI+"machines/RollingMill"               ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, RollBender                = new RecipeMap                     (null, "gt.recipe.rollbender"                   , "Гибочный станок"            , null, 0, 1, RES_PATH_GUI+"machines/RollBender"                ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, RollFormer                = new RecipeMap                     (null, "gt.recipe.rollformer"                   , "Сортовой прокатный станок"  , null, 0, 1, RES_PATH_GUI+"machines/RollFormer"                ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, LaserEngraver             = new RecipeMap                     (null, "gt.recipe.laserengraver"                , "Лазерный гравер"            , null, 0, 1, RES_PATH_GUI+"machines/LaserEngraver"             ,/*IN-OUT-MIN-ITEM=*/ 2, 1, 2,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Welder                    = new RecipeMap                     (null, "gt.recipe.welder"                       , "Лазерный сварщик"           , null, 0, 1, RES_PATH_GUI+"machines/Welder"                    ,/*IN-OUT-MIN-ITEM=*/ 9, 1, 2,/*IN-OUT-MIN-FLUID=*/ 1, 0, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Anvil                     = new RecipeMap                     (null, "gt.recipe.anvil"                        , "Наковальня"                 , null, 2, 1, RES_PATH_GUI+"machines/Anvil"                     ,/*IN-OUT-MIN-ITEM=*/ 2, 2, 2,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, AnvilBendSmall            = new RecipeMap                     (null, "gt.recipe.anvil.bend.small"             , "Изгиб наковальни (Малый)"   , null, 2, 1, RES_PATH_GUI+"machines/AnvilBendingSmall"         ,/*IN-OUT-MIN-ITEM=*/ 2, 2, 2,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, AnvilBendBig              = new RecipeMap                     (null, "gt.recipe.anvil.bend.big"               , "Изгиб наковальни (Большой)" , null, 2, 1, RES_PATH_GUI+"machines/AnvilBendingBig"           ,/*IN-OUT-MIN-ITEM=*/ 2, 2, 2,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	
	, Centrifuge                = new RecipeMap                     (null, "gt.recipe.centrifuge"                   , "Центрифуга"                 , null, 0, 1, RES_PATH_GUI+"machines/Centrifuge"                ,/*IN-OUT-MIN-ITEM=*/ 1, 6, 0,/*IN-OUT-MIN-FLUID=*/ 1, 6, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Electrolyzer              = new RecipeMap                     (null, "gt.recipe.electrolyzer"                 , "Электролизер"               , null, 0, 1, RES_PATH_GUI+"machines/Electrolyzer"              ,/*IN-OUT-MIN-ITEM=*/ 2, 6, 1,/*IN-OUT-MIN-FLUID=*/ 2, 6, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	
	, ToolHeads                 = new RecipeMap                     (null, "gt.recipe.toolhead"                     , "Сборка основы и рукоятки"   , null, 0, 1, RES_PATH_GUI+"machines/Crafting2By2"              ,/*IN-OUT-MIN-ITEM=*/ 4, 1, 0,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 0, ""                    ,    1, ""      , F, T, F, F, F, F, F)
	, Sharpening                = new RecipeMap                     (null, "gt.recipe.sharpener"                    , "Точильный станок"           , null, 0, 1, RES_PATH_GUI+"machines/Sharpener"                 ,/*IN-OUT-MIN-ITEM=*/ 1, 2, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	...
	, Crusher                   = new RecipeMap                     (null, "gt.recipe.crusher"                      , "Дробитель"                  , null, 0, 1, RES_PATH_GUI+"machines/Crusher"                   ,/*IN-OUT-MIN-ITEM=*/ 1,12, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Extruder                  = new RecipeMap                     (null, "gt.recipe.extruder"                     , "Экструдер"                  , null, 0, 1, RES_PATH_GUI+"machines/Extruder"                  ,/*IN-OUT-MIN-ITEM=*/ 2, 2, 2,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Hammer                    = new RecipeMapHammer               (null, "gt.recipe.hammer"                       , "Молот"                      , null, 6, 3, RES_PATH_GUI+"machines/Hammer"                    ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Chisel                    = new RecipeMapChisel               (null, "gt.recipe.chisel"                       , "Долото"                     , null, 0, 1, RES_PATH_GUI+"machines/Chisel"                    ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, F, T, T, F, T, T)
	
	, Nanofab                   = new RecipeMap                     (null, "gt.recipe.nanofab"                      , "Нано-фабрикатор"            , null, 0, 1, RES_PATH_GUI+"machines/Nanofab"                   ,/*IN-OUT-MIN-ITEM=*/ 2, 1, 0,/*IN-OUT-MIN-FLUID=*/ 1, 1, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Printer                   = new RecipeMapPrinter              (null, "gt.recipe.printer"                      , "Принтер"                    , null, 0, 1, RES_PATH_GUI+"machines/Printer"                   ,/*IN-OUT-MIN-ITEM=*/ 2, 1, 1,/*IN-OUT-MIN-FLUID=*/ 6, 0, 1,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, F, F)
	, ScannerVisuals            = new RecipeMapScannerVisuals       (null, "gt.recipe.scannervisuals"               , "Сканер (Визуальный)"        , null, 0, 1, RES_PATH_GUI+"machines/ScannerVisuals"            ,/*IN-OUT-MIN-ITEM=*/ 2, 2, 2,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, ScannerMolecular          = new RecipeMapScannerMolecular     (null, "gt.recipe.scannermolecular"             , "Молекулярный сканер"        , null, 0, 1, RES_PATH_GUI+"machines/ScannerMolecular"          ,/*IN-OUT-MIN-ITEM=*/ 2, 1, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, F, F)
	, Massfab                   = new RecipeMap                     (null, "gt.recipe.massfab"                      , "Генератор материи"          , null, 0, 1, RES_PATH_GUI+"machines/Massfab"                   ,/*IN-OUT-MIN-ITEM=*/ 2, 1, 0,/*IN-OUT-MIN-FLUID=*/ 1, 2, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, F, F)
	, Replicator                = new RecipeMapReplicator           (null, "gt.recipe.replicator"                   , "Репликатор материи"         , null, 0, 1, RES_PATH_GUI+"machines/Replicator"                ,/*IN-OUT-MIN-ITEM=*/ 3, 3, 1,/*IN-OUT-MIN-FLUID=*/ 3, 3, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, F, F)
	, Fusion                    = new RecipeMap                     (null, "gt.recipe.fusionreactor"                , "Термоядерный реактор"       , null, 0, 1, RES_PATH_GUI+"machines/Fusion"                    ,/*IN-OUT-MIN-ITEM=*/ 2, 6, 1,/*IN-OUT-MIN-FLUID=*/ 2, 6, 0,/*MIN*/ 2,/*AMP=*/ 1, "Start: "             ,    1, " LU"   , T, T, T, T, F, T, T)
	
	, Canner                    = new RecipeMapFluidCanner          (null, "gt.recipe.canner"                       , "Наполнитель"                , null, 0, 1, RES_PATH_GUI+"machines/Canner"                    ,/*IN-OUT-MIN-ITEM=*/ 2, 2, 1,/*IN-OUT-MIN-FLUID=*/ 1, 1, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Boxinator                 = new RecipeMap                     (null, "gt.recipe.boxinator"                    , "Упаковщик"                  , null, 0, 1, RES_PATH_GUI+"machines/Boxinator"                 ,/*IN-OUT-MIN-ITEM=*/ 2, 1, 2,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Unboxinator               = new RecipeMapUnboxinator          (null, "gt.recipe.unboxinator"                  , "Распоковщик"                , null, 0, 1, RES_PATH_GUI+"machines/Unboxinator"               ,/*IN-OUT-MIN-ITEM=*/ 1,12, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	, Generifier                = new RecipeMap                     (null, "gt.recipe.generifier"                   , "Обобщитель"                 , null, 0, 1, RES_PATH_GUI+"machines/Generifier"                ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 0,/*IN-OUT-MIN-FLUID=*/ 1, 1, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, F, F)
	
	, BedrockOreList            = new RecipeMap                     (null, "gt.recipe.bedrockorelist"               , "Бур коренной породы"        , null, 0, 1, RES_PATH_GUI+"machines/BedrockOreList"            ,/*IN-OUT-MIN-ITEM=*/ 1,12, 1,/*IN-OUT-MIN-FLUID=*/ 1, 0, 1,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, F, T, F, F, F)
	, ByProductList             = new RecipeMap                     (null, "gt.recipe.byproductlist"                , "Список вторичных материалов", null, 0, 1, RES_PATH_GUI+"machines/OreByproducts"             ,/*IN-OUT-MIN-ITEM=*/ 6,12, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, F, T, F, T, T)
	
	// Mostly unused Stuff from olden times
	, BlastFurnace              = new RecipeMap                     (null, "gt.recipe.blastfurnace"                 , "Доменная печь"              , null, 0, 1, RES_PATH_GUI+"machines/Default"                   ,/*IN-OUT-MIN-ITEM=*/ 2, 2, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, "Heat Capacity: "     ,    1, " K"    , F, F/*T*/, F/*T*/, T, F, T, T)
	, VacuumFreezer             = new RecipeMap                     (null, "gt.recipe.vacuumfreezer"                , "Вакуумный морозильник"      , null, 0, 1, RES_PATH_GUI+"machines/Default"                   ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 1,/*IN-OUT-MIN-FLUID=*/ 0, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, F/*T*/, F/*T*/, T, F, T, T)
	, Assembler                 = new RecipeMapAssembler            (null, "gt.recipe.assembler"                    , "Сборщик"                    , null, 0, 1, RES_PATH_GUI+"machines/Assembler"                 ,/*IN-OUT-MIN-ITEM=*/ 2, 1, 1,/*IN-OUT-MIN-FLUID=*/ 1, 0, 0,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, F/*T*/, F/*T*/, T, F, T, T)
	, CNC                       = new RecipeMap                     (null, "gt.recipe.cncmachine"                   , "CNC машина"                 , null, 0, 1, RES_PATH_GUI+"machines/Default"                   ,/*IN-OUT-MIN-ITEM=*/ 2, 1, 2,/*IN-OUT-MIN-FLUID=*/ 1, 0, 1,/*MIN*/ 0,/*AMP=*/ 1, ""                    ,    1, ""      , T, F/*T*/, F/*T*/, T, F, T, T)
	;
	...
	public static boolean add_smelting(ItemStack aInput, ItemStack aOutput, float aEXP, boolean aRemoveOthers, boolean aSmoker, boolean aBlast) {
		...
		if (MD.EtFu.mLoaded) try {
			...
			ERR.println("Если вы не обновили Et Futurum Requiem, возможно стоит это сделать.");
