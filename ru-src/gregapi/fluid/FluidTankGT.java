...
public class FluidTankGT implements IFluidTank {
	...
	public String contentcap() {return mFluid == null ? "Емкость: " + UT.Code.makeString(mCapacity) + " L" : UT.Code.makeString(amount()) + " L of " + name(T) + " (" + (FL.gas(mFluid) ? "Gaseous" : "Liquid") + "); Max: "+UT.Code.makeString(capacity())+" L)";}
