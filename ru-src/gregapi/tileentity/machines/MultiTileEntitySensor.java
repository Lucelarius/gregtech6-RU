...
public abstract class MultiTileEntitySensor extends TileEntityBase10FacingDouble implements ITileEntityQuickObstructionCheck, IMTE_IgnorePlayerCollisionWhenPlacing, IMTE_SetBlockBoundsBasedOnState, IMTE_GetCollisionBoundingBoxFromPool, IMTE_GetSelectedBoundingBoxFromPool, IMTE_SyncDataShort {
	...
	static {LH.add("gt.tooltip.sensor.screwdrive.buttons"   , "Используйте Отвертку на кнопках, чтобы включить режим усреднения.");}
	static {LH.add("gt.tooltip.sensor.screwdrive.display"   , "Используйте отвертку на дисплее, чтобы переключить шестнадцатеричный дисплей.");}
	static {LH.add("gt.tooltip.sensor.screwdrive.modes"     , "Используйте отвертку для переключения режимов.");}
