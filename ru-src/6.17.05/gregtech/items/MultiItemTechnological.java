...
public class MultiItemTechnological extends MultiItemRandomWithCompat {
	...
	public void addItems() {
		...
		IL.Cover_Blank                           .set(addItem( 1000, "Пустое покрытие"                                   , "*ПУСТО*"                                                                 , new CoverTextureMulti(T, T, "machines/covers/blank/", 6)   , TC.stack(TC.MACHINA, 2)));
		IL.Cover_Crafting                        .set(addItem( 1001, "Покрытие с верстаком"                              , "Обычный верстак в виде прикрытия"                                        , new CoverCrafting("machines/covers/crafting/", 6)          , TC.stack(TC.MACHINA, 1), TC.stack(TC.FABRICO, 3)));
		IL.Cover_Machine_Display                 .set(addItem( 1002, "Индикатор состояния машины"                        , "Показывает состояние машины и имеет переключатель ВКЛ/ВЫКЛ"              , new CoverControllerDisplay()                               , TC.stack(TC.MACHINA, 1), TC.stack(TC.SENSUS, 3)));
		IL.Cover_Auto_Switch                     .set(addItem( 1003, "Автоматический выключатель"                        , "Автоматически ВКЛ/ВЫКЛ машины при необходимости"                         , new CoverControllerAuto()                                  , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 3)));
		IL.Cover_Energy_Display                  .set(addItem( 1004, "Индикатор энергии"                                 , "Отображает хранящуюся энергию"                                           , new CoverDisplayEnergy()                                   , TC.stack(TC.MACHINA, 1), TC.stack(TC.SENSUS, 2), TC.stack(TC.POTENTIA, 1)));
		IL.Cover_Redstone_Switch                 .set(addItem( 1005, "Ручной выключатель"                                , "ВКЛ/ВЫКЛ машины с помощью сигнала красного камня"                        , new CoverControllerRedstone()                              , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 2)));
		IL.Cover_Auto_Switch_Redstone            .set(addItem( 1006, "Полуавтоматический выключатель"                    , "ВКЛ/ВЫКЛ машины с помощью сигнала красного камня, но позволяет закончить", new CoverControllerAutoRedstone()                          , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 3)));
		IL.Cover_Redstone_Selector               .set(addItem( 1007, "Красный переключатель"                             , "Управляется сигналом красного камня"                                     , new CoverSelectorRedstone()                                , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 2)));
		IL.Cover_Manual_Selector                 .set(addItem( 1008, "Ручной переключатель"                              , "Управляется кнопками"                                                    , new CoverSelectorManual()                                  , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 2)));
		IL.Cover_Auto_Switch_01_Minute           .set(addItem( 1009, "Переключатель автоматической перезагрузки (1 мин)" , "Перезапускает устройство каждую минуту"                                  , new CoverControllerAutoTimer( 1200)                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Auto_Switch_05_Minute           .set(addItem( 1010, "Переключатель автоматической перезагрузки (5 мин)" , "Перезапускает устройство каждые 5 минут"                                 , new CoverControllerAutoTimer( 6000)                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Auto_Switch_10_Minute           .set(addItem( 1011, "Переключатель автоматической перезагрузки (10 мин)", "Перезапускает устройство каждые 10 минут"                                , new CoverControllerAutoTimer(12000)                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Auto_Switch_20_Minute           .set(addItem( 1012, "Переключатель автоматической перезагрузки (20 мин)", "Перезапускает устройство каждые 20 минут"                                , new CoverControllerAutoTimer(24000)                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Auto_Switch_30_Minute           .set(addItem( 1013, "Переключатель автоматической перезагрузки (30 мин)", "Перезапускает устройство каждые 30 минут"                                , new CoverControllerAutoTimer(36000)                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Scale_Energy                    .set(addItem( 1014, "Датчик энергии"                                    , "Излучение зависит от колличества энергии"                                , new CoverScaleEnergy()                                     , TC.stack(TC.MACHINA, 2), TC.stack(TC.POTENTIA, 1)));
		IL.Cover_Detector_Possible               .set(addItem( 1015, "Датчик активности (Ожидание)"                      , "Выдает сигнал красного камня при готовности"                             , new CoverDetectorRunningPossible()                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Detector_Passively              .set(addItem( 1016, "Датчик активности (Активно)"                       , "Выдает сигнал красного камня когда запущен"                              , new CoverDetectorRunningPassively()                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Detector_Actively               .set(addItem( 1017, "Датчик активности (Обработка)"                     , "Выдает сигнал красного камня при обработке"                              , new CoverDetectorRunningActively()                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Scale_Progress                  .set(addItem( 1018, "Датчик прогресса"                                  , "Излучает сигнал красного камня в зависимости от прогресса"               , new CoverScaleProgress()                                   , TC.stack(TC.MACHINA, 2), TC.stack(TC.FABRICO, 1)));
		IL.Cover_Detector_Success                .set(addItem( 1019, "Датчик активности (Успех)"                         , "Выдает сигнал красного камня при оканчании процесса"                     , new CoverDetectorRunningSuccessfully()                     , TC.stack(TC.MACHINA, 2), TC.stack(TC.FABRICO, 1)));
		IL.Cover_Drain                           .set(addItem( 1020, "Дренаж"                                            , ""                                                                        , new CoverDrain()                                           , TC.stack(TC.MACHINA, 1), TC.stack(TC.AQUA, 1), TC.stack(TC.VACUOS, 1)));
		IL.Cover_Redstone_Emitter                .set(addItem( 1021, "Излучатель сигнала красного сигнала"               , "Постоянно излучает сигнал красного камня"                                , new CoverRedstoneEmitter()                                 , TC.stack(TC.MACHINA, 1), TC.stack(TC.POTENTIA, 1)));
		IL.Cover_Vent                            .set(addItem( 1022, "Вентиляционное отверстие"                          , "Вентилирует воздух в резервуары и трубы"                                 , new CoverVent()                                            , TC.stack(TC.MACHINA, 1), TC.stack(TC.AER, 1), TC.stack(TC.VACUOS, 1)));
		IL.Cover_Filter_Item                     .set(addItem( 1023, "Фильтр предметов"                                  , "Фильтр для предметов"                                                    , new CoverFilterItem()                                      , TC.stack(TC.MACHINA, 1), TC.stack(TC.ORDO, 1), TC.stack(TC.ITER, 1)));
		IL.Cover_Filter_Fluid                    .set(addItem( 1024, "Фильтр жидкостей"                                  , "Фильтр для жидкостей"                                                    , new CoverFilterFluid()                                     , TC.stack(TC.MACHINA, 1), TC.stack(TC.ORDO, 1), TC.stack(TC.AQUA, 1)));
		IL.Cover_Controller                      .set(addItem( 1025, "Контроллер покрытий"                               , "ВКЛ/ВЫКЛ сигнал красного камня на покрытия"                              , new CoverControllerCovers()                                , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 2)));
		IL.Cover_Shutter                         .set(addItem( 1026, "Заглушка"                                          , "Соединяет и разделяет трубы и провода"                                   , new CoverShutter()                                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Button_Selector                 .set(addItem( 1027, "Кнопочная панель"                                  , "Крышка настройщика, управляемая кнопками"                                , new CoverSelectorButtonPanel()                             , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Warning                         .set(addItem( 1028, "Предупреждающее покрытие"                          , "Предупреждает об определенных типах опасности"                           , new CoverTextureMulti(T, T, "machines/covers/warning/", 20), TC.stack(TC.MACHINA, 1), TC.stack(TC.SENSUS, 1), TC.stack(TC.VINCULUM, 1)));
		IL.Cover_Redstone_Conductor_IN           .set(addItem( 1029, "Крышка проводника сигнала кр.камня (Прием)"        , "Сигнал красного камня перейдет к излучающим проводникам"                 , new CoverRedstoneConductorIN()                             , TC.stack(TC.MACHINA, 2), TC.stack(TC.SENSUS, 1)));
		IL.Cover_Redstone_Conductor_OUT          .set(addItem( 1030, "Крышка проводника сигнала кр.камня (Излучение)"    , "Сигнал красного камня предеается на принимающий проводник"               , new CoverRedstoneConductorOUT()                            , TC.stack(TC.MACHINA, 2), TC.stack(TC.VINCULUM, 1)));
		IL.Cover_Retriever_Item                  .set(addItem( 1031, "Извлекатель предметов"                             , "Извлекает предметы из трубопровода"                                      , new CoverRetrieverItem()                                   , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 1), TC.stack(TC.VACUOS, 1), TC.stack(TC.ITER, 1)));
		...
		IL.Cover_Logistics_Display_CPU_Logic     .set(addItem( 1086, "Дисплей логистики (ЦП Логика)"             , "Для использования с ядрами логистики и проводкой"         , CoverLogisticsDisplayCPULogic.INSTANCE                     , TC.stack(TC.MACHINA, 2), TC.stack(TC.SENSUS, 2), TC.stack(TC.ITER, 1)));
		IL.Cover_Logistics_Display_CPU_Control   .set(addItem( 1087, "Дисплей логистики (ЦП Управление)"         , "Для использования с ядрами логистики и проводкой"         , CoverLogisticsDisplayCPUControl.INSTANCE                   , TC.stack(TC.MACHINA, 2), TC.stack(TC.SENSUS, 2), TC.stack(TC.ITER, 1)));
		IL.Cover_Logistics_Display_CPU_Storage   .set(addItem( 1088, "Дисплей логистики (ЦП память)"             , "Для использования с ядрами логистики и проводкой"         , CoverLogisticsDisplayCPUStorage.INSTANCE                   , TC.stack(TC.MACHINA, 2), TC.stack(TC.SENSUS, 2), TC.stack(TC.ITER, 1)));
		IL.Cover_Logistics_Display_CPU_Conversion.set(addItem( 1089, "Дисплей логистики (ЦП Конвертация)"        , "Для использования с ядрами логистики и проводкой"         , CoverLogisticsDisplayCPUConversion.INSTANCE                , TC.stack(TC.MACHINA, 2), TC.stack(TC.SENSUS, 2), TC.stack(TC.ITER, 1)));
		IL.Cover_Logistics_Fluid_Export          .set(addItem( 1090, "Логический фильтр шины экспорта (Жидкость)", "Для использования с ядрами логистики и проводкой"         , CoverLogisticsFluidExport.INSTANCE                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Fluid_Import          .set(addItem( 1091, "Логический фильтр шины импорта (Жидкость)" , "Для использования с ядрами логистики и проводкой"         , CoverLogisticsFluidImport.INSTANCE                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Fluid_Storage         .set(addItem( 1092, "Логический фильтр шины хранения (Жидкость)", "Для использования с ядрами логистики и проводкой"         , CoverLogisticsFluidStorage.INSTANCE                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Item_Export           .set(addItem( 1093, "Логический фильтр шины экспорта (Предметы)", "Для использования с ядрами логистики и проводкой"         , CoverLogisticsItemExport.INSTANCE                          , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Item_Import           .set(addItem( 1094, "Логический фильтр шины импорта (Предметы)" , "Для использования с ядрами логистики и проводкой"         , CoverLogisticsItemImport.INSTANCE                          , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Item_Storage          .set(addItem( 1095, "Логический фильтр шины хранения (Предметы)", "Для использования с ядрами логистики и проводкой"         , CoverLogisticsItemStorage.INSTANCE                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Generic_Export        .set(addItem( 1096, "Общая логическая шина экспорта"            , "Для использования с ядрами логистики и проводкой"         , CoverLogisticsGenericExport.INSTANCE                       , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Generic_Import        .set(addItem( 1097, "Общая логическая шина импорта"             , "Для использования с ядрами логистики и проводкой"         , CoverLogisticsGenericImport.INSTANCE                       , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Generic_Storage       .set(addItem( 1098, "Общая логическая шина хранения"            , "Для использования с ядрами логистики и проводкой"         , CoverLogisticsGenericStorage.INSTANCE                      , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Dump                  .set(addItem( 1099, "Логическая шина утилизации (Предметы)"     , "Для использования с ядрами логистики и проводкой"         , CoverLogisticsGenericDump.INSTANCE                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		...
		IL.Cover_Pressure_Valve            .set(addItem( 2000, "Клапан давления"                   , ""                                                , new CoverPressureValve()                              , TC.stack(TC.MACHINA, 1), TC.stack(TC.AER, 1), TC.stack(TC.VACUOS, 1)));
		...
		IL.Shape_Extruder_Empty            .set(addItem(10000, "Пустая форма экструдера"                  , "Необработанная пластина для создания форм экструдера"          , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		
		CR.shaped(IL.Shape_Extruder_Empty.get(1), CR.DEF_REV, "hf" , "xP", 'P', OP.plateDouble.dat(MT.TungstenCarbide));
		
		IL.Shape_Extruder_Plate            .set(addItem(10001, "Форма экструдера (Пластина)"            , "Форма экструдера для изготовления пластин"                       , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Rod_Long         .set(addItem(10002, "Форма экструдера (Длинный стержень)"    , "Форма экструдера для изготовления длинных стержней"              , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Bolt             .set(addItem(10003, "Форма экструдера (Болт)"                , "Форма экструдера для изготовления болтов"                        , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Ring             .set(addItem(10004, "Форма экструдера (Кольцо)"              , "Форма экструдера для изготовления колец"                         , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Cell             .set(addItem(10005, "Форма экструдера (Капсула)"             , "Форма экструдера для изготовления капсул"                        , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Ingot            .set(addItem(10006, "Форма экструдера (Слиток)"              , "Форма экструдера для изготовления слитков"                       , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Wire             .set(addItem(10007, "Форма экструдера (Провод)"              , "Форма экструдера для изготовления проводов"                      , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Casing           .set(addItem(10008, "Форма экструдера (Оболочка)"            , "Форма экструдера для изготовления оболочек"                      , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pipe_Tiny        .set(addItem(10009, "Форма экструдера (Крохотная труба)"     , "Форма экструдера для изготовления крохотных труб"                , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pipe_Small       .set(addItem(10010, "Форма экструдера (Малая труба)"         , "Форма экструдера для изготовления малых труб"                    , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pipe_Medium      .set(addItem(10011, "Форма экструдера (Труба)"               , "Форма экструдера для изготовления труб"                          , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pipe_Large       .set(addItem(10012, "Форма экструдера (Большая труба)"       , "Форма экструдера для изготовления больших труб"                  , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pipe_Huge        .set(addItem(10013, "Форма экструдера (Огромная труба)"      , "Форма экструдера для изготовления огромных труб"                 , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Block            .set(addItem(10014, "Форма экструдера (Блок)"                , "Форма экструдера для изготовления блоков"                        , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Sword            .set(addItem(10015, "Форма экструдера (Лезвие меча)"         , "Форма экструдера для изготовления мечей"                         , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pickaxe          .set(addItem(10016, "Форма экструдера (Основа кирки)"        , "Форма экструдера для изготовления кирок"                         , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Shovel           .set(addItem(10017, "Форма экструдера (Основа лопаты)"       , "Форма экструдера для изготовления лопат"                         , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Axe              .set(addItem(10018, "Форма экструдера (Основа топора)"       , "Форма экструдера для изготовления топоров"                       , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Hoe              .set(addItem(10019, "Форма экструдера (Основа мотыги)"       , "Форма экструдера для изготовления мотыг"                         , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Hammer           .set(addItem(10020, "Форма экструдера (Основа молота)"       , "Форма экструдера для изготовления молотов"                       , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_File             .set(addItem(10021, "Форма экструдера (Основа напильника)"   , "Форма экструдера для изготовления напильников"                   , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Saw              .set(addItem(10022, "Форма экструдера (Лезвие пилы)"         , "Форма экструдера для изготовления пил"                           , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Gear             .set(addItem(10023, "Форма экструдера (Шестерня)"            , "Форма экструдера для изготовления шестерней"                     , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Bottle           .set(addItem(10024, "Форма экструдера (Бутылка)"             , "Форма экструдера для изготовления бутылок"                       , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Plate_Curved     .set(addItem(10025, "Форма экструдера (Гнутая пластина)"     , "Форма экструдера для изготовления гнутых пластин"                , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Gear_Small       .set(addItem(10026, "Форма экструдера (Малая шестерня)"      , "Форма экструдера для изготовления малых шестерней"               , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Rod              .set(addItem(10027, "Форма экструдера (Стержень)"            , "Форма экструдера для изготовления стержней"                      , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_CCC              .set(addItem(10028, "Форма экструдера (Капсульный контейнер)", "Форма экструдера для изготовления капсульных контейнеров"        , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Foil             .set(addItem(10029, "Форма экструдера (Фольга)"              , "Форма экструдера для изготовления фольги из неметаллов"          , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Plate_Tiny       .set(addItem(10030, "Форма экструдера (Малая пластина)"      , "Форма экструдера для изготовления малых пластин"                 , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Wire_Fine        .set(addItem(10031, "Форма экструдера (Проволока)"           , "Форма экструдера для изготовления тонкой проволоки из неметаллов", TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		...
		IL.Shape_SimpleEx_Empty            .set(addItem(10200, "Пустая форма экструдера"                                    , "Необработанная пластина для создания форм экструдера", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		
		CR.shaped(IL.Shape_SimpleEx_Empty.get(1), CR.DEF_REV, "hf" , "xP", 'P', OP.plateDouble.dat(ANY.Steel));
		
		IL.Shape_SimpleEx_Plate            .set(addItem(10201, "Форма низкотемпературного экструдера (Пластина)"            , "Форма экструдера для изготовления пластин"                       , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Rod_Long         .set(addItem(10202, "Форма низкотемпературного экструдера (Длинный стержень)"    , "Форма экструдера для изготовления длинных стержней"              , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Bolt             .set(addItem(10203, "Форма низкотемпературного экструдера (Болт)"                , "Форма экструдера для изготовления болтов"                        , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Ring             .set(addItem(10204, "Форма низкотемпературного экструдера (Кольцо)"              , "Форма экструдера для изготовления колец"                         , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Cell             .set(addItem(10205, "Форма низкотемпературного экструдера (Капсула)"             , "Форма экструдера для изготовления капсул"                        , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Ingot            .set(addItem(10206, "Форма низкотемпературного экструдера (Слиток)"              , "Форма экструдера для изготовления слитков"                       , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Wire             .set(addItem(10207, "Форма низкотемпературного экструдера (Провод)"              , "Форма экструдера для изготовления проводов"                      , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Casing           .set(addItem(10208, "Форма низкотемпературного экструдера (Оболочка)"            , "Форма экструдера для изготовления оболочек"                      , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pipe_Tiny        .set(addItem(10209, "Форма низкотемпературного экструдера (Крохотная труба)"     , "Форма экструдера для изготовления крохотных труб"                , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pipe_Small       .set(addItem(10210, "Форма низкотемпературного экструдера (Малая труба)"         , "Форма экструдера для изготовления малых труб"                    , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pipe_Medium      .set(addItem(10211, "Форма низкотемпературного экструдера (Труба)"               , "Форма экструдера для изготовления труб"                          , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pipe_Large       .set(addItem(10212, "Форма низкотемпературного экструдера (Большая труба)"       , "Форма экструдера для изготовления больших труб"                  , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pipe_Huge        .set(addItem(10213, "Форма низкотемпературного экструдера (Огромная труба)"      , "Форма экструдера для изготовления огромных труб"                 , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Block            .set(addItem(10214, "Форма низкотемпературного экструдера (Блок)"                , "Форма экструдера для изготовления блоков"                        , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Sword            .set(addItem(10215, "Форма низкотемпературного экструдера (Лезвие меча)"         , "Форма экструдера для изготовления мечей"                         , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pickaxe          .set(addItem(10216, "Форма низкотемпературного экструдера (Основа кирки)"        , "Форма экструдера для изготовления кирок"                         , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Shovel           .set(addItem(10217, "Форма низкотемпературного экструдера (Основа лопаты)"       , "Форма экструдера для изготовления лопат"                         , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Axe              .set(addItem(10218, "Форма низкотемпературного экструдера (Основа топора)"       , "Форма экструдера для изготовления топоров"                       , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Hoe              .set(addItem(10219, "Форма низкотемпературного экструдера (Основа мотыги)"       , "Форма экструдера для изготовления мотыг"                         , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Hammer           .set(addItem(10220, "Форма низкотемпературного экструдера (Основа молота)"       , "Форма экструдера для изготовления молотов"                       , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_File             .set(addItem(10221, "Форма низкотемпературного экструдера (Основа напильника)"   , "Форма экструдера для изготовления напильников"                   , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Saw              .set(addItem(10222, "Форма низкотемпературного экструдера (Лезвие пилы)"         , "Форма экструдера для изготовления пил"                           , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Gear             .set(addItem(10223, "Форма низкотемпературного экструдера (Шестерня)"            , "Форма экструдера для изготовления шестерней"                     , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Bottle           .set(addItem(10224, "Форма низкотемпературного экструдера (Бутылка)"             , "Форма экструдера для изготовления бутылок"                       , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Plate_Curved     .set(addItem(10225, "Форма низкотемпературного экструдера (Гнутая пластина)"     , "Форма экструдера для изготовления гнутых пластин"                , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Gear_Small       .set(addItem(10226, "Форма низкотемпературного экструдера (Малая шестерня)"      , "Форма экструдера для изготовления малых шестерней"               , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Rod              .set(addItem(10227, "Форма низкотемпературного экструдера (Стержень)"            , "Форма экструдера для изготовления стержней"                      , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_CCC              .set(addItem(10228, "Форма низкотемпературного экструдера (Капсульный контейнер)", "Форма экструдера для изготовления капсульных контейнеров"        , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Foil             .set(addItem(10229, "Форма низкотемпературного экструдера (Фольга)"              , "Форма экструдера для изготовления фольги из неметаллов"          , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Plate_Tiny       .set(addItem(10230, "Форма низкотемпературного экструдера (Малая пластина)"      , "Форма экструдера для изготовления малых пластин"                 , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Wire_Fine        .set(addItem(10231, "Форма низкотемпературного экструдера (Проволока)"           , "Форма экструдера для изготовления тонкой проволоки из неметаллов", TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		...
		IL.Shape_Foodmold_Empty            .set(addItem(10800, "Пустая пищевая форма"           , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		
		CR.shaped(IL.Shape_Foodmold_Empty.get(1), CR.DEF_REV, "hf" , "xP", 'P', OP.plateDouble.dat(MT.StainlessSteel));
		
		IL.Shape_Foodmold_Bun              .set(addItem(10801, "Пищевая форма (Булочка)"        , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Foodmold_Bread            .set(addItem(10802, "Пищевая форма (Хлеб)"           , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Foodmold_Baguette         .set(addItem(10803, "Пищевая форма (Багет)"          , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Foodmold_Cylinder         .set(addItem(10804, "Пищевая форма (Цилиндр)"        , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Foodmold_Toast            .set(addItem(10805, "Пищевая форма (Тосты)"          , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		...
		IL.Shape_Press_Bullet_Casing_Small .set(addItem(10896, "Форма для гильзы (Малый калибр)"  , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.TELUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Press_Bullet_Casing_Medium.set(addItem(10897, "Форма для гильзы (Средний калибр)", "", TC.stack(TC.FABRICO, 2), TC.stack(TC.TELUM, 3))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Press_Bullet_Casing_Large .set(addItem(10898, "Форма для гильзы (Крупный калибр)", "", TC.stack(TC.FABRICO, 2), TC.stack(TC.TELUM, 4))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		...
		IL.Shape_Slicer_Empty              .set(addItem(10900, "Рамка лезвия ломтерезки"           , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		
		CR.shaped(IL.Shape_Slicer_Empty.get(1), CR.DEF_REV, " R ", "RhR", " R ", 'R', OP.stick.dat(MT.StainlessSteel));
		
		IL.Shape_Slicer_Flat               .set(addItem(10901, "Лезвие ломтерезки (Плоское)"       , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Grid               .set(addItem(10902, "Лезвие ломтерезки (Решетка)"       , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Eigths             .set(addItem(10903, "Лезвие ломтерезки (Восмерка)"      , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Eigths_Hollow      .set(addItem(10904, "Лезвие ломтерезки (Полая восмерка)", "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Split              .set(addItem(10905, "Лезвие ломтерезки (Половинка)"     , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Quarters           .set(addItem(10906, "Лезвие ломтерезки (Четверть)"      , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Quarters_Hollow    .set(addItem(10907, "Лезвие ломтерезки (Полая четверть)", "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		...
		IL.Comp_Laser_Gas_Empty            .set(addItem(11000, "Пустой газовый лазерный излучатель"        , "Для электрических лазеров"                        , TC.stack(TC.LUX, 1), TC.stack(TC.VACUOS, 2)));
		...
		IL.Comp_Laser_Gas_He               .set(addItem(11001, "Гелиевый лазерный излучатель"              , "Назначение: слабые оптические приборы"            , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_Ne               .set(addItem(11002, "Неоновый лазерный излучатель"              , "Назначение: слабые оптические приборы"            , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_Ar               .set(addItem(11003, "Аргоновый лазерный излучатель"             , "Назначение: сильные оптические приборы"           , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_Kr               .set(addItem(11004, "Криптонитовый лазерный излучатель"         , "Назначение: Наука"                                , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_Xe               .set(addItem(11005, "Ксеноновый лазерный излучатель"            , "Назначение: Наука"                                , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_HeNe             .set(addItem(11006, "Гелий-неоновый лазерный излучатель"        , "Назначение: Слабые оптические приборы"            , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_CO               .set(addItem(11007, "Лазерный излучатель на монооксиде углерода", "Назначение: Обработка слабых материалов"          , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_CO2              .set(addItem(11008, "Лазерный излучатель на диоксиде углерода"  , "Назначение: Обработка сильных материалов"         , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		...
		IL.Battery_Lead_Acid_Cell_Empty    .set(addItem(20000, "Свинцово-кислотная капсула (Пусто)"    , "Часть аккумулятора (Наполнитель не требуется!)" , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.METALLUM, 2), TC.stack(TC.VACUOS , 2), new OreDictItemData(MT.Pb, U, MT.BatteryAlloy, U)));
		IL.Battery_Lead_Acid_Cell_Filled   .set(addItem(20001, "Свинцово-кислотная капсула (Заполнено)", "Часть аккумулятора"                             , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.ELECTRUM, 2), TC.stack(TC.VENEMUM, 2), new OreDictItemData(MT.Pb, U, MT.BatteryAlloy, U, MT.H2SO4, 2*U), new FluidContainerData(MT.H2SO4.liquid(2*U, T), ST.make(this, 1, 20001), next(), last(), F)));
		...
		IL.Battery_LiCoO2_Cell_Empty       .set(addItem(20006, "Литий-кобольтовая капсула (Пусто)"     , "Часть аккумулятора (Наполнитель не требуется!)" , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.METALLUM, 2), TC.stack(TC.VACUOS , 2), new OreDictItemData(OM.stack(MT.BatteryAlloy, U), OM.stack(MT.Co, U2), OM.stack(MT.Cr, U), OM.stack(ANY.Plastic, U2), OM.stack(MT.Graphite, U2), OM.stack(MT.LiClO4, U*2))));
		IL.Battery_LiCoO2_Cell_Filled      .set(addItem(20007, "Литий-кобольтовая капсула (Заполнено)" , "Часть аккумулятора"                             , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.ELECTRUM, 2), TC.stack(TC.VENEMUM, 2), new OreDictItemData(OM.stack(MT.BatteryAlloy, U), OM.stack(MT.Co, U2), OM.stack(MT.Cr, U), OM.stack(ANY.Plastic, U2), OM.stack(MT.Graphite, U2), OM.stack(MT.LiClO4, U*2), OM.stack(MT.HCl, U*2)), new FluidContainerData(MT.HCl.gas(U*2, T), ST.make(this, 1, tLastID), next(), last(), F)));
		...
		IL.Battery_LiMn_Cell_Empty         .set(addItem(20008, "Литий-марганцевая капсула (Пусто)"     , "Часть аккумулятора (Наполнитель не требуется!)" , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.METALLUM, 2), TC.stack(TC.VACUOS , 2), new OreDictItemData(OM.stack(MT.BatteryAlloy, U), OM.stack(MT.Mn, U2), OM.stack(MT.Cr, U), OM.stack(ANY.Plastic, U2), OM.stack(MT.Graphite, U2), OM.stack(MT.LiClO4, U*2))));
		IL.Battery_LiMn_Cell_Filled        .set(addItem(20009, "Литий-марганцевая капсула (Заполнено)" , "Часть аккумулятора"                             , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.ELECTRUM, 2), TC.stack(TC.VENEMUM, 2), new OreDictItemData(OM.stack(MT.BatteryAlloy, U), OM.stack(MT.Mn, U2), OM.stack(MT.Cr, U), OM.stack(ANY.Plastic, U2), OM.stack(MT.Graphite, U2), OM.stack(MT.LiClO4, U*2), OM.stack(MT.HF, U*2)), new FluidContainerData(MT.HF.gas(U*2, T), ST.make(this, 1, tLastID), next(), last(), F)));
		...
		IL.Electrode_FR_Copper              .set(addItem(29987, "Электрод (Медь)"                , "Требуется пробирка"                                , new OreDictItemData(ANY.Cu            , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Tin                 .set(addItem(29988, "Электрод (Олово)"               , "Требуется пробирка"                                , new OreDictItemData(MT.Sn             , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Bronze              .set(addItem(29989, "Электрод (Бронза)"              , "Требуется пробирка"                                , new OreDictItemData(MT.Bronze         , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Iron                .set(addItem(29990, "Электрод (Железо)"              , "Требуется пробирка"                                , new OreDictItemData(ANY.Fe            , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Gold                .set(addItem(29991, "Электрод (Золото)"              , "Требуется пробирка"                                , new OreDictItemData(MT.Au             , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Diamond             .set(addItem(29992, "Электрод (Алмаз)"               , "Требуется пробирка"                                , new OreDictItemData(ANY.Diamond       , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Obsidian            .set(addItem(29993, "Электрод (Обсидиан)"            , "Требуется пробирка"                                , new OreDictItemData(MT.Obsidian       , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Blaze               .set(addItem(29994, "Электрод (Огненный порошок)"    , "Требуется пробирка"                                , new OreDictItemData(MT.Blaze          , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Rubber              .set(addItem(29995, "Электрод (Резина)"              , "Требуется пробирка"                                , new OreDictItemData(ANY.Rubber        , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Emerald             .set(addItem(29996, "Электрод (Изумруд)"             , "Требуется пробирка"                                , new OreDictItemData(ANY.Emerald       , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Apatite             .set(addItem(29997, "Электрод (Апатит)"              , "Требуется пробирка"                                , new OreDictItemData(MT.Apatite        , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Lapis               .set(addItem(29998, "Электрод (Лазурит)"             , "Требуется пробирка"                                , new OreDictItemData(MT.Lapis          , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Ender               .set(addItem(29999, "Электрод (Ender)"               , "Требуется пробирка"                                , new OreDictItemData(MT.Endstone       , 5*U4, MT.EnderEye, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		...
		IL.Circuit_Plate_Empty             .set(addItem(30000, "Текстолит"                          , "Требуется контурная проводка"                    , new OreDictItemData(ANY.SiO2, U, ANY.Plastic, U), TC.stack(TC.FABRICO, 1)));
		...
		IL.Circuit_Wire_Copper             .set(addItem(30001, "Контурная проводка (Медь)"          , "Необходимо разместить на пустом текстолите"      , new OreDictItemData(MT.Cu, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.PERMUTATIO, 1)));
		IL.Circuit_Plate_Copper            .set(addItem(30002, "Текстолит (Медь)"                   , "Требуется контурный компонент"                   , new OreDictItemData(MT.Cu, U, ANY.SiO2, U, ANY.Plastic, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.PERMUTATIO, 1)));
		IL.Circuit_Wire_Gold               .set(addItem(30003, "Контурная проводка (Золото)"        , "Необходимо разместить на пустом текстолите"      , new OreDictItemData(MT.Au, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.LUCRUM, 1)));
		IL.Circuit_Plate_Gold              .set(addItem(30004, "Текстолит (Золото)"                 , "Требуется контурный компонент"                   , new OreDictItemData(MT.Au, U, ANY.SiO2, U, ANY.Plastic, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.LUCRUM, 1), "oc:materialCircuitBoardPrinted"));
		IL.Circuit_Wire_Platinum           .set(addItem(30005, "Контурная проводка (Платина)"       , "Необходимо разместить на пустом текстолите"      , new OreDictItemData(MT.Pt, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.NEBRISUM, 1)));
		IL.Circuit_Plate_Platinum          .set(addItem(30006, "Текстолит (Платина)"                , "Требуется контурный компонент"                   , new OreDictItemData(MT.Pt, U, ANY.SiO2, U, ANY.Plastic, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.NEBRISUM, 1)));
		
		IL.Circuit_Wire_Magic              .set(addItem(30011, "Контурная проводка (Магия)"         , "Необходимо разместить на пустом текстолите"      , TC.stack(TC.FABRICO, 1), TC.stack(TC.PRAECANTIO, 1)));
		IL.Circuit_Plate_Magic             .set(addItem(30012, "Текстолит (Магия)"                  , "Требуется контурный компонент"                   , new OreDictItemData(ANY.SiO2, U, ANY.Plastic, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.PRAECANTIO, 1)));
		IL.Circuit_Wire_Enderium           .set(addItem(30013, "Контурная проводка (Эндерий)"       , "Необходимо разместить на пустом текстолите"      , new OreDictItemData(MT.Enderium, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.ALIENIS, 1)));
		IL.Circuit_Plate_Enderium          .set(addItem(30014, "Текстолит (Эндерий)"                , "Требуется контурный компонент"                   , new OreDictItemData(MT.Enderium, U, ANY.SiO2, U, ANY.Plastic, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.ALIENIS, 1)));
		IL.Circuit_Wire_Signalum           .set(addItem(30015, "Контурная проводка (Сигналий)"      , "Необходимо разместить на пустом текстолите"      , new OreDictItemData(MT.Signalum, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.POTENTIA, 1)));
		IL.Circuit_Plate_Signalum          .set(addItem(30016, "Текстолит (Сигналий)"               , "Требуется контурный компонент"                   , new OreDictItemData(MT.Signalum, U, ANY.SiO2, U, ANY.Plastic, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.POTENTIA, 1)));
		
		IL.Circuit_Plate_HSLA              .set(addItem(30099, "Текстолит (HSLA)"                   , "Требуется контурный компонент"                   , new OreDictItemData(MT.HSLA, U, MT.Au, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.MACHINA, 1), MD.RoC.mLoaded ? null : TD.Creative.HIDDEN));
		...
		IL.Circuit_Part_Basic              .set(addItem(30101, "Контурный компнент (Базовая)"          , "Необходимо разместить на медном текстолите"     , TC.stack(TC.COGNITIO, 1)));
		IL.Circuit_Part_Good               .set(addItem(30102, "Контурный компнент (Хорошая)"          , "Необходимо разместить на медном текстолите"     , TC.stack(TC.COGNITIO, 1)));
		IL.Circuit_Part_Advanced           .set(addItem(30103, "Контурный компнент (Продвинутая)"      , "Необходимо разместить на золотом текстолите"    , TC.stack(TC.COGNITIO, 1)));
		IL.Circuit_Part_Elite              .set(addItem(30104, "Контурный компнент (Элитная)"          , "Необходимо разместить на золотом текстолите"    , TC.stack(TC.COGNITIO, 1)));
		IL.Circuit_Part_Master             .set(addItem(30105, "Контурный компнент (Мастер)"           , "Необходимо разместить на платиновом текстолите" , TC.stack(TC.COGNITIO, 1)));
		IL.Circuit_Part_Ultimate           .set(addItem(30106, "Контурный компнент (Максимальная)"     , "Необходимо разместить на платиновом текстолите" , TC.stack(TC.COGNITIO, 1)));
		
		IL.Circuit_Part_Magic              .set(addItem(30111, "Контурный компнент (Магическая)"       , "Необходимо разместить на магическом текстолите" , TC.stack(TC.PRAECANTIO, 1)));
		IL.Circuit_Part_Enderium           .set(addItem(30113, "Контурный компнент (Эндерий)"          , "Необходимо разместить на эндериевом текстолите" , TC.stack(TC.ALIENIS, 1)));
		IL.Circuit_Part_Signalum           .set(addItem(30115, "Контурный компнент (Сигналий)"         , "Необходимо разместить на сигналиевом текстолите", TC.stack(TC.POTENTIA, 1)));
		
		IL.Circuit_Part_EnderPearl         .set(addItem(30198, "Контурный компнент (Жемчуг Края)"      , "Необходимо разместить на текстолите"            , TC.stack(TC.ALIENIS, 1)));
		IL.Circuit_Part_EnderEye           .set(addItem(30199, "Контурный компнент (Око Края)"         , "Необходимо разместить на текстолите"            , TC.stack(TC.ALIENIS, 1)));
		...
		IL.Circuit_Board_Basic             .set(addItem(30201, "Печатная плата (Базовая)"          , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Good              .set(addItem(30202, "Печатная плата (Хорошая)"          , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Advanced          .set(addItem(30203, "Печатная плата (Продвинутая)"      , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Elite             .set(addItem(30204, "Печатная плата (Элитная)"          , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Master            .set(addItem(30205, "Печатная плата (Мастер)"           , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Ultimate          .set(addItem(30206, "Печатная плата (Максимальная)"     , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1)));
		
		IL.Circuit_Board_Magic             .set(addItem(30211, "Печатная плата (Магическая)"       , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Enderium          .set(addItem(30213, "Печатная плата (Эндерий)"          , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Signalum          .set(addItem(30215, "Печатная плата (Сигналий)"         , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1)));
		
		IL.Circuit_Board_BC_Redstone       .set(addItem(30280, "Печатная плата (BC Кр.камень)"     , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U))));
		IL.Circuit_Board_BC_Iron           .set(addItem(30281, "Печатная плата (BC железо)"        , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Fe, 4*U))));
		IL.Circuit_Board_BC_Gold           .set(addItem(30282, "Печатная плата (BC золото)"        , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(MT.Au, 4*U))));
		IL.Circuit_Board_BC_Diamond        .set(addItem(30283, "Печатная плата (BC алмаз)"         , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Diamond, 4*U))));
		IL.Circuit_Board_BC_Ender          .set(addItem(30284, "Печатная плата (BC Ender)"         , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(MT.EnderPearl, 4*U))));
		IL.Circuit_Board_BC_Quartz         .set(addItem(30285, "Печатная плата (BC кварц)"         , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,5*U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U))));
		IL.Circuit_Board_BC_Comparator     .set(addItem(30286, "Печатная плата (BC компаратор)"    , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone,16*U))));
		IL.Circuit_Board_BC_Emerald        .set(addItem(30287, "Печатная плата (BC изумруд)"       , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Emerald, 4*U))));
		
		IL.Circuit_Board_HSLA_Circuit      .set(addItem(30298, "Печатная плата (HSLA схема)"       , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1), MD.RoC.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Circuit_Board_Power_Module      .set(addItem(30299, "Печатная плата (Силовой модуль)"   , "Необходимо правильно припаять"                   , TC.stack(TC.FABRICO, 1), MD.RoC.mLoaded ? null : TD.Creative.HIDDEN));
		...
		IL.Circuit_Basic                   .set(addItem(30301, "Электросхема T1 (Базовая)"     , "Очень медленно вычисляет простые данные"        , MT.DATA.CIRCUITS[1], OD_CIRCUITS[1], TC.stack(TC.COGNITIO, 2)));
		IL.Circuit_Good                    .set(addItem(30302, "Электросхема T2 (Хорошая)"     , "Медленно вычисляет простые данные"              , MT.DATA.CIRCUITS[2], OD_CIRCUITS[2], TC.stack(TC.COGNITIO, 3)));
		IL.Circuit_Advanced                .set(addItem(30303, "Электросхема T3 (Продвинутая)" , "Вычисляет простые данные со средней скоростью"  , MT.DATA.CIRCUITS[3], OD_CIRCUITS[3], TC.stack(TC.COGNITIO, 4)));
		IL.Circuit_Elite                   .set(addItem(30304, "Электросхема T4 (Элитная)"     , "Вычисляет простые данные с повышенной скоростью", MT.DATA.CIRCUITS[4], OD_CIRCUITS[4], TC.stack(TC.COGNITIO, 5)));
		IL.Circuit_Master                  .set(addItem(30305, "Электросхема T5 (Мастер)"      , "Эффективно вычисляет простые данные"            , MT.DATA.CIRCUITS[5], OD_CIRCUITS[5], TC.stack(TC.COGNITIO, 6)));
		IL.Circuit_Ultimate                .set(addItem(30306, "Электросхема T6 (Максимальная)", "Очень эффективно вычисляет простые данные"      , MT.DATA.CIRCUITS[6], OD_CIRCUITS[6], TC.stack(TC.COGNITIO, 7)));
		
		IL.Circuit_Magic                   .set(addItem(30311, "Электросхема (Магическая)"     , "Вычисляет простые магические данные"            , OP.circuit.dat(MT.Magic)));
		IL.Circuit_Enderium                .set(addItem(30313, "Электросхема (Эндерий)"        , "Вычисляет простые данные где-то еще"            , OP.circuit.dat(MT.Enderium)));
		IL.Circuit_Signalum                .set(addItem(30315, "Электросхема (Сигналий)"       , "Вычисляет простую логику"                       , OP.circuit.dat(MT.Signalum)));
		
		IL.Circuit_BC_Redstone             .set(addItem(30380, "Электросхема (BC Кр.камень)"   , "Создан для настройки рецептов"                  , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 1), TC.stack(TC.POTENTIA, 3), TC.stack(TC.MACHINA, 1)     , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U))));
		IL.Circuit_BC_Iron                 .set(addItem(30381, "Электросхема (BC железо)"      , "Создан для настройки рецептов"                  , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 2), TC.stack(TC.METALLUM, 4)                              , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Fe, 4*U))));
		IL.Circuit_BC_Gold                 .set(addItem(30382, "Электросхема (BC золото)"      , "Создан для настройки рецептов"                  , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 3), TC.stack(TC.LUCRUM, 2), TC.stack(TC.METALLUM, 2)      , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(MT.Au, 4*U))));
		IL.Circuit_BC_Diamond              .set(addItem(30383, "Электросхема (BC алмаз)"       , "Создан для настройки рецептов"                  , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 4), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2)       , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Diamond, 4*U))));
		IL.Circuit_BC_Ender                .set(addItem(30384, "Электросхема (BC Ender)"       , "Создан для настройки рецептов"                  , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 3), TC.stack(TC.ALIENIS, 4)                               , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(MT.EnderPearl, 4*U))));
		IL.Circuit_BC_Quartz               .set(addItem(30385, "Электросхема (BC кварц)"       , "Создан для настройки рецептов"                  , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 2), TC.stack(TC.POTENTIA, 2), TC.stack(TC.VITREUS, 2)     , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,5*U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U))));
		IL.Circuit_BC_Comparator           .set(addItem(30386, "Электросхема (BC компаратор)"  , "Создан для настройки рецептов"                  , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 2), TC.stack(TC.MACHINA, 4)                               , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone,16*U))));
		IL.Circuit_BC_Emerald              .set(addItem(30387, "Электросхема (BC изумруд)"     , "Создан для настройки рецептов"                  , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 4), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2)       , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Emerald, 4*U))));
		...
		IL.Circuit_Crystal_Diamond         .set(addItem(30401, "Кристаллическая схема (Алмаз)"       , "Логический алмаз"                     , TC.stack(TC.COGNITIO, 3), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(OM.stack(ANY.Diamond, U))));
		IL.Circuit_Crystal_Ruby            .set(addItem(30402, "Кристаллическая схема (Рубин)"       , "Управляющий рубин"                    , TC.stack(TC.COGNITIO, 3), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(OM.stack(MT.Ruby, U))));
		IL.Circuit_Crystal_Emerald         .set(addItem(30403, "Кристаллическая схема (Изумруд)"     , "Изумрудная память"                    , TC.stack(TC.COGNITIO, 3), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(OM.stack(ANY.Emerald, U))));
		IL.Circuit_Crystal_Sapphire        .set(addItem(30404, "Кристаллическая схема (Сапфир)"      , "Конвертирующий сапфир"                , TC.stack(TC.COGNITIO, 3), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(OM.stack(ANY.Sapphire, U))));
		
		IL.Processor_Crystal_Empty         .set(addItem(30500, "Сокет кристаллического процессора"   , "Основа для кристаллической схемы"     , TC.stack(TC.COGNITIO, 5), TC.stack(TC.VACUOS, 2)));
		IL.Processor_Crystal_Diamond       .set(addItem(30501, "Кристаллический процессор (Алмаз)"   , "Схема логического процессора"         , TC.stack(TC.COGNITIO, 5), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(MT.Pt, U, ANY.Diamond, U)));
		IL.Processor_Crystal_Ruby          .set(addItem(30502, "Кристаллический процессор (Рубин)"   , "Схема управляющего процессора"        , TC.stack(TC.COGNITIO, 5), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(MT.Pt, U, MT.Ruby, U)));
		IL.Processor_Crystal_Emerald       .set(addItem(30503, "Кристаллический процессор (Изумруд)" , "Схема запоминающего процессора"       , TC.stack(TC.COGNITIO, 5), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(MT.Pt, U, ANY.Emerald, U)));
		IL.Processor_Crystal_Sapphire      .set(addItem(30504, "Кристаллический процессор (Сапфир)"  , "Схема конвертирующего процессора"     , TC.stack(TC.COGNITIO, 5), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(MT.Pt, U, ANY.Sapphire, U)));
		...
		IL.USB_Stick_1                     .set(addItem(32001, "USB-накопитель 1.0"                    , "Хранит данные"                                     , OD_USB_STICKS[1], Behavior_DataStorage.INSTANCE, TC.stack(TC.COGNITIO, 3), TC.stack(TC.ELECTRUM, 1)                       )); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_Stick_2                     .set(addItem(32002, "USB-накопитель 2.0"                    , "Хранит данные"                                     , OD_USB_STICKS[2], Behavior_DataStorage.INSTANCE, TC.stack(TC.COGNITIO, 4), TC.stack(TC.ELECTRUM, 2), TC.stack(TC.MOTUS, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_Stick_3                     .set(addItem(32003, "USB-накопитель 3.0"                    , "Хранит данные"                                     , OD_USB_STICKS[3], Behavior_DataStorage.INSTANCE, TC.stack(TC.COGNITIO, 5), TC.stack(TC.ELECTRUM, 3), TC.stack(TC.MOTUS, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_Stick_4                     .set(addItem(32004, "USB-накопитель 4.0"                    , "Хранит данные"                                     , OD_USB_STICKS[4], Behavior_DataStorage.INSTANCE, TC.stack(TC.COGNITIO, 6), TC.stack(TC.ELECTRUM, 4), TC.stack(TC.MOTUS, 3))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		...
		IL.USB_Cable_1                     .set(addItem(32011, "USB-кабель 1.0"                    , "Заменяет USB-накопители при подключении к USB-портам" , OD_USB_CABLES[1], TC.stack(TC.COGNITIO, 2), TC.stack(TC.ELECTRUM, 1)                      ));
		IL.USB_Cable_2                     .set(addItem(32012, "USB-кабель 2.0"                    , "Заменяет USB-накопители при подключении к USB-портам" , OD_USB_CABLES[2], TC.stack(TC.COGNITIO, 3), TC.stack(TC.ELECTRUM, 2), TC.stack(TC.ITER, 1)));
		IL.USB_Cable_3                     .set(addItem(32013, "USB-кабель 3.0"                    , "Заменяет USB-накопители при подключении к USB-портам" , OD_USB_CABLES[3], TC.stack(TC.COGNITIO, 4), TC.stack(TC.ELECTRUM, 3), TC.stack(TC.ITER, 2)));
		IL.USB_Cable_4                     .set(addItem(32014, "USB-кабель 4.0"                    , "Заменяет USB-накопители при подключении к USB-портам" , OD_USB_CABLES[4], TC.stack(TC.COGNITIO, 5), TC.stack(TC.ELECTRUM, 4), TC.stack(TC.ITER, 3)));
		...
		IL.USB_HDD_1                       .set(addItem(32021, "USB 1.0 HDD"                      , "Хранит до 16 файлов одновременно"                   , OD_USB_DRIVES[1], Behavior_DataStorage16.INSTANCE, TC.stack(TC.COGNITIO, 3), TC.stack(TC.ELECTRUM, 2), TC.stack(TC.MOTUS, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_HDD_2                       .set(addItem(32022, "USB 2.0 HDD"                      , "Хранит до 16 файлов одновременно"                   , OD_USB_DRIVES[2], Behavior_DataStorage16.INSTANCE, TC.stack(TC.COGNITIO, 4), TC.stack(TC.ELECTRUM, 3), TC.stack(TC.MOTUS, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_HDD_3                       .set(addItem(32023, "USB 3.0 HDD"                      , "Хранит до 16 файлов одновременно"                   , OD_USB_DRIVES[3], Behavior_DataStorage16.INSTANCE, TC.stack(TC.COGNITIO, 5), TC.stack(TC.ELECTRUM, 4), TC.stack(TC.MOTUS, 3))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_HDD_4                       .set(addItem(32024, "USB 4.0 HDD"                      , "Хранит до 16 файлов одновременно"                   , OD_USB_DRIVES[4], Behavior_DataStorage16.INSTANCE, TC.stack(TC.COGNITIO, 6), TC.stack(TC.ELECTRUM, 5), TC.stack(TC.MOTUS, 4))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
