...
public class MultiTileEntityReactorRodModerator extends MultiTileEntityReactorRodBase {
	...
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		...
		aList.add(LH.Chat.CYAN + "Отражает нейтроны в обратном направлении, умноженное на количество соприкасающихся ТВЭЛ в активном состоянии.");
		aList.add(LH.Chat.CYAN + "Touching Fuel Rods become moderated and moderate touching Fuel Rods.");
		aList.add(LH.Chat.CYAN + "Замедляющие стержни нельзя использовать для обогащения, их срок службы составляет лишь четверть этого срока.");
	}
