...
public class BlockTreeLogBFireProof extends BlockBaseLog implements IBlockToolable {
	public BlockTreeLogBFireProof(String aUnlocalised) {
		...
		LH.add(getUnlocalizedName()+ ".0", "Бревно орешника (Огнеупорный)");
		LH.add(getUnlocalizedName()+ ".4", "Бревно орешника (Огнеупорный)");
		LH.add(getUnlocalizedName()+ ".8", "Бревно орешника (Огнеупорный)");
		LH.add(getUnlocalizedName()+".12", "Бревно орешника (Огнеупорный)");
		...
		LH.add(getUnlocalizedName()+ ".1", "Бревно дерева корицы (Огнеупорный)");
		LH.add(getUnlocalizedName()+ ".5", "Бревно дерева корицы (Огнеупорный)");
		LH.add(getUnlocalizedName()+ ".9", "Бревно дерева корицы (Огнеупорный)");
		LH.add(getUnlocalizedName()+".13", "Бревно дерева корицы (Огнеупорный)");
		...
		LH.add(getUnlocalizedName()+ ".2", "Бревно кокосового дерева (Огнеупорный)");
		LH.add(getUnlocalizedName()+ ".6", "Бревно кокосового дерева (Огнеупорный)");
		LH.add(getUnlocalizedName()+".10", "Бревно кокосового дерева (Огнеупорный)");
		LH.add(getUnlocalizedName()+".14", "Бревно кокосового дерева (Огнеупорный)");
		...
		LH.add(getUnlocalizedName()+ ".3", "Бревно радужного дерева (Огнеупорный)");
		LH.add(getUnlocalizedName()+ ".7", "Бревно радужного дерева (Огнеупорный)");
		LH.add(getUnlocalizedName()+".11", "Бревно радужного дерева (Огнеупорный)");
		LH.add(getUnlocalizedName()+".15", "Бревно радужного дерева (Огнеупорный)");
