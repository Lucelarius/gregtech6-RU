...
public class Loader_Tools implements Runnable {
	...
	public void run() {
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH                    , "Гаечный ключ"                            , "Удерживайте ЛКМ, чтобы демонтировать машины"                   , new GT_Tool_Wrench()                                           .setMaterialAmount(4*U                                       ), OreDictToolNames.wrench                                                                                                                  , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.MACHINA       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_wrench);
...
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                           .setMaterialAmount(3*U                                       ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH             , "Разводной ключ"                          , "Удерживайте ЛКМ, чтобы демонтировать машины"                   , new GT_Tool_MonkeyWrench()                                     .setMaterialAmount(4*U                                       ), OreDictToolNames.monkeywrench, OreDictToolNames.wrench                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.MACHINA       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_monkeywrench);
