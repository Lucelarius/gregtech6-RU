...
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                           .setMaterialAmount(3*U                                       ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH_HV                 , "Электроключ (HV)"                        , "Нажмите ПКМ, чтобы переключиться на разводной ключ"            , new GT_Tool_Wrench_HV(ToolsGT.MONKEY_WRENCH_HV)                .setMaterialAmount(toolHeadWrench                    .mAmount), OreDictToolNames.wrench, OreDictToolNames.monkeywrench                                                                                         , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_wrench);
