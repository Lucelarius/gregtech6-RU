...
public class MultiTileEntityVonDaGraagg extends TileEntityBase10MultiBlockBase implements ITileEntityEnergy, ITileEntityMobSpawnInhibitor, IMultiBlockEnergy, ITileEntityProgress, ITileEntityGibbl {
	...
	static {
		LH.add("gt.tooltip.multiblock.von.da.graagg.1", "Бесшовное основание 5x5x2 из 41 плотной оцинкованной стальной стены с главным блоком внизу по центру.");
		LH.add("gt.tooltip.multiblock.von.da.graagg.2", "5-метровый столб из большой медной катушки с дополнительной +1 плотной стальной стеной сверху.");
		LH.add("gt.tooltip.multiblock.von.da.graagg.3", "Обмотать сверху бесшовным основанием 3x3x3 из 16 плотных стальных стен.");
		LH.add("gt.tooltip.multiblock.von.da.graagg.4", "Предотвращает появление мобов, кроме как на замшелом булыжнике. Дальность действия зависит от входных данных.");
	}
	...
	public void onMagnifyingGlass2(List<String> aChatReturn) {
		aChatReturn.add("Радиус квадрата: " + mCurrentRange + "м из 256м");
	}
